package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2661:FriendListLookAndFeel;
      
      private var var_408:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1882:OpenedToWebPopup;
      ...
      private var var_1881:AvatarSearchResults;
      ...
      {
         this.var_2661 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_95 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1881 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1882 = new OpenedToWebPopup(this);
         }
         this.var_1882.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_99);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_273,HabboWindowStyle.const_41,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1066.createAvatarImage(param1,AvatarScaleType.const_87,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_1128,this.getText("friendlist.friends")));
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_348,this.getText("friendlist.friends.offlinecaption")));
         ...
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_95.findCategory(FriendCategory.const_348);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_403));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_408.findTab(FriendListTab.const_94).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_408.findTab(FriendListTab.const_94);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1881.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_408.findTab(FriendListTab.const_94);
         if(!_loc2_)
         {
            return;
         }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(this.var_779.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_367.vipLimit;
         }
         else if(this.var_779.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_40))
         {
