package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_713 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_713.procedure = this.onSearchInput;
         this.var_713.addEventListener(WindowKeyboardEvent.const_173,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_57.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_344,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = this.var_57.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
            ...
            this.var_57.addListItem(_loc10_);
         }
         if(param1)
         {
            _loc10_.height = 20;
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(this.var_57.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_713.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_713.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_713.text;
