package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1813:int = "F".charCodeAt(0);
      
      public static const const_1939:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_918 = param1.gender;
         this.var_736 = param1.online;
         this.var_1503 = param1.followingAllowed && param1.online;
         this.var_589 = param1.figure;
         this.var_1501 = param1.motto;
         this.var_1502 = param1.lastAccess;
         this.var_1288 = param1.categoryId;
         this.var_1500 = param1.realName;
