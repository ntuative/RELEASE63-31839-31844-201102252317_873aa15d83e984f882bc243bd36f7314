package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1500 != "")
         {
            friendList.refreshText(param1,"name_text_online",this.var_736,this.var_1500);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",this.var_736,this.var_1742);
         }
         friendList.refreshText(param1,"name_text_offline",!this.var_736,this.var_1742);
         friendList.refreshText(param1,"motto_text",this.var_736,this.var_2017);
         friendList.refreshButton(param1,"offline",!this.var_736,null,0);
         if(this.var_736)
         {
            this.refreshFigure(param1,this.var_2021);
