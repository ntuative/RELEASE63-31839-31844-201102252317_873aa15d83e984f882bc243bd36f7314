package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_1370:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1370 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_888 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_247 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1370.prepare(this.var_888);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1067,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1210,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_850,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_771,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_850,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_771,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1369 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1369.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1697 == -1 ? 0 : int(this.var_16.height - this.var_1697);
         var _loc4_:int = this.var_1698 == -1 ? 0 : int(this.var_16.width - this.var_1698);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_247.y = Util.getLowestPoint(this.var_16.content);
         this.var_247.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1184,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_850,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1067,false);
         ...
         this.var_1697 = this.var_16.height;
         this.var_1698 = this.var_16.width;
