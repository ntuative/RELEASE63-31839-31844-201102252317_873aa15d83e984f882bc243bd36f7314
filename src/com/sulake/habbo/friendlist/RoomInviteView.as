package com.sulake.habbo.friendlist
{
   ...
   public class RoomInviteView extends AlertView
   {
      ...
      public function RoomInviteView(param1:HabboFriendList)
      {
         ...
         this.var_191 = param1.categories.getSelectedFriends();
      }
      ...
      {
         friendList.registerParameter("friendlist.invite.summary","count","" + this.var_191.length);
         this.var_810 = ITextFieldWindow(param1.findChildByName("message_input"));
      ...
      private function sendMsg() : void
      {
         ...
         for each(_loc3_ in this.var_191)
         {
