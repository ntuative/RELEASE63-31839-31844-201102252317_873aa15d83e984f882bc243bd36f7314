package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_751:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2053:IContainerButtonWindow;
      
      private var var_2052:IContainerButtonWindow;
      
      private var var_2054:IContainerButtonWindow;
      ...
      {
         this.var_2053 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2052 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2054 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2051 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_99).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_57.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
            ...
            this.var_57.addListItem(_loc6_);
         }
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_751);
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_99,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_751);
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_99,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2053,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2052,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2054,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2051,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_99,param4);
         _loc6_.visible = true;
      }
