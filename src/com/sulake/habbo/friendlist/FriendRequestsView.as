package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1698:String = "no_reqs_info";
      ...
      private var var_1725:IContainerButtonWindow;
      ...
      {
         this.var_1725 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1724 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1724.procedure = this.onDismissAllButtonClick;
         this.var_1725.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_57.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_57.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_306,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_399 && _loc4_.state != FriendRequest.const_398)
            {
               _loc4_.state = FriendRequest.const_398;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_306,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_399 && _loc4_.state != FriendRequest.const_398)
            {
               ...
               _loc4_.state = FriendRequest.const_399;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1725,_loc1_);
         this.setEnabled(this.var_1724,_loc1_);
      }
