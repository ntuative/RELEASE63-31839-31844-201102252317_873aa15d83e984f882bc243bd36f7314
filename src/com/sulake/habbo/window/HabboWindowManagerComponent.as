package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1250:IEventDispatcher;
      
      private var var_1007:Boolean = false;
      
      private var var_1504:ProfilerOutput;
      
      private var var_1249:ProfilerAgentTask;
      
      private var var_1248:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_812 = new WindowRenderer(this.var_811);
         this.var_186 = new Array(const_411);
         ...
         {
            this.var_186[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_812,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_186[const_1221];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_347,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1599,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1504)
            {
               this.var_1504 = new ProfilerOutput(context,this,this.var_812);
            }
            this.var_1504.profiler = _loc3_;
            this.var_1249 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1249);
            this.var_1248 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1248);
            this.var_1007 = true;
         }
      }
      ...
      {
         var _loc3_:Dictionary = this.var_318[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_318[0][param1] as XML : _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_375.length > 0)
         {
            this.var_1250.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_411 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1250.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_375.length > 0)
         {
            WindowContext.var_375.flush();
         }
         this.var_1250.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1503,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1660,param2.name + ": " + param2.toString());
            }
