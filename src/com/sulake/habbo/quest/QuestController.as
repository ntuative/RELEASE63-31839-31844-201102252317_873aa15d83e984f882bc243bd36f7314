package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_308:QuestCampaign;
      ...
      public function activateQuest(param1:Quest) : void
      {
         if(param1)
         {
            this.var_193.communication.getHabboMainConnection(null).send(new ActivateQuestMessageComposer(param1.id));
         }
      }
      ...
      {
         if(this.var_567 != MODE_TABS)
         {
            this.var_567 = MODE_NO_TABS;
         }
         this.detachCampaign();
         ...
         this.var_308 = _loc4_;
         this.var_308.openCampaign(param3);
         this.prepareWindow();
         this.attachCampaign();
         if(this.var_567 == MODE_TABS)
         {
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1195.addChild(this.var_308.window);
         var _loc1_:String = "quest_" + this.var_308.code;
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_193.getXmlWindow(_loc1_));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this._window.center();
         this.var_1195 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_163.getKeys())
         {
            ...
            if(!_loc2_)
            {
               _loc2_ = this.var_193.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_450) as ITabButtonWindow;
      ...
      private function onTabSelect(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         this.var_193.getQuestCampaign(param2.caption);
      }
   }
}
