package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_525:Quest;
      
      private var var_310:QuestView;
      ...
      private var var_309:IItemListWindow;
      ...
      private function reset() : void
      {
         ...
         if(this.var_373)
         {
            ...
            {
               this.var_309.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_373 = null;
            this.var_309.destroyListItems();
            this.var_309.removeListItems();
         }
         this.var_525 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1214 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1478 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_309 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1478.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1478.findChildByName("currency.amount").caption = "${quest_" + this.var_1926 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_1215 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1215)
         {
            this.var_1215.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1215.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1215.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_525)
         {
            this.var_525.selected = false;
         }
         if(this.var_177)
         {
            this.var_1214.addChild(this.var_177.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1644);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1478.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_373.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_373)
         {
            this.var_309.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_45 || _loc4_.status == QuestStatusEnum.const_491))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_309.maxScrollV > 0)
            {
               this.var_309.scrollV = _loc3_.view.y / this.var_309.maxScrollV;
            }
         }
         else if(this.var_373.length > 0)
         {
            this.activateListItem(this.var_373[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_525 = param1;
         this.var_525.selected = true;
         this.showQuestData(this.var_525);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_310 = new QuestView(this,param1);
         this.var_1214.addChild(this.var_310.view);
         this.var_310.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_785.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_785)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_785.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_785.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_373[_loc3_] = _loc5_;
            _loc6_ = this.var_309.getListItemIndex(_loc2_.view);
            this.var_309.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_309.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_309.addListItem(_loc5_.view);
            }
            if(this.var_525 == _loc2_)
            {
