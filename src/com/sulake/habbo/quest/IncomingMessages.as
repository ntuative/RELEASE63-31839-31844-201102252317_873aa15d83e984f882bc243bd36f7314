package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_193:HabboQuestEngine;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_714:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_193 = param1;
         this._communication = this.var_193.communication;
      ...
      private function onQuestList(param1:IMessageEvent) : void
      {
         ...
         this.var_193.controller.openCampaign(_loc2_.campaignCode,_loc2_.activityPointType,_loc2_.quests);
      }
      ...
      private function onQuestAccepted(param1:IMessageEvent) : void
      {
         ...
         this.var_193.controller.questAccepted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_193.controller.questCompleted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onAvailableQuestCampaign(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length == 0)
         {
            ...
            this.var_714 = this.var_193.windowManager.alert("quest.nocampaigns.title","quest.nocampaigns.desc",0,this.onCloseAlert);
         }
         else
         {
            this.var_193.controller.openCampaigns(_loc2_.campaignCodes);
         }
      }
      ...
      private function onExpiredQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length > 0)
         {
            this.var_193.controller.openCampaigns(_loc2_.campaignCodes,true);
         }
      }
      ...
      private function onQuestingEnabled(param1:IMessageEvent) : void
      {
         ...
         if(this.var_193.toolbar != null)
         {
            if(_loc2_.isEnabled)
            {
               this.var_193.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.QUESTS));
            }
            else
            {
               this.var_193.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_193.controller.updatePurse();
      }
