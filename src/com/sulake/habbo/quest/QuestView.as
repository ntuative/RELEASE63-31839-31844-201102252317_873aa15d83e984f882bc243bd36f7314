package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1557:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_93.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1557 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
      ...
      private function localize() : void
      {
         ...
         {
            this.var_1556 = -1;
            QuestUtils.method_6(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_1556 == param1)
         {
            _loc3_ = this.find("quest.image") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               _loc3_.height = param2.height + 5;
               QuestUtils.method_6(_loc3_,param2,_loc3_.height);
               this.updateMargins();
            }
         }
      }
