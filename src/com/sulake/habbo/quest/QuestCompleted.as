package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private var var_212:IFrameWindow;
      ...
      private function onQuestCompletedRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_212.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
      ...
      {
         this.var_212 = IFrameWindow(this.var_62.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         this.var_212.findChildByTag("close").procedure = this.onCompletedDialogClose;
         this.var_212.center();
         var _loc2_:IWindow = this.var_212.findChildByName("button.catalog");
         if(_loc2_)
         {
         ...
         this.var_212.caption = "${quest.completed}";
         this.var_212.findChildByName("reward.description").caption = "${" + _loc3_ + ".completed.reward}";
         ...
         this.var_212.findChildByName("description").caption = this.var_62.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_212.findChildByName("reward.currency.desc").caption = this.var_62.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
         var _loc5_:String = "icon_" + this.var_62.code + "_reward_" + param1.rewardCurrencyAmount;
         var _loc6_:IBitmapWrapperWindow = this.var_212.findChildByName("reward.currency.icon") as IBitmapWrapperWindow;
