package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1188:IHabboWindowManager;
      ...
      private var var_635:FramerateTracker = null;
      
      private var var_262:LatencyTracker = null;
      
      private var var_637:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_635 = new FramerateTracker();
         this.var_262 = new LatencyTracker();
         this.var_637 = new LagWarningLogger();
         this.var_636 = new ToolbarClickTracker(this);
         this.var_1458 = new Array(const_961);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1642,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_667,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1133,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1188)
            {
               this.var_1188.release(new IIDHabboWindowManager());
               this.var_1188 = null;
            }
            if(this.var_284)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboRoomSettingsTrackingEvent.HABBO_ROOM_SETTINGS_TRACKING_EVENT_CLOSED,this.method_3);
                  this._navigator.events.removeEventListener(HabboRoomSettingsTrackingEvent.HABBO_ROOM_SETTINGS_TRACKING_EVENT_DEFAULT,this.method_3);
                  this._navigator.events.removeEventListener(HabboRoomSettingsTrackingEvent.HABBO_ROOM_SETTINGS_TRACKING_EVENT_ADVANCED,this.method_3);
                  this._navigator.events.removeEventListener(HabboRoomSettingsTrackingEvent.HABBO_ROOM_SETTINGS_TRACKING_EVENT_THUMBS,this.method_3);
               }
            ...
            if(this.var_199)
            {
               if(!this.var_199.disposed)
               {
                  ...
                  Component(this.var_199).events.removeEventListener(HabboFriendListTrackingEvent.const_403,this.onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_180)
         {
            if(this.var_262 != null)
            {
               this.var_262.configuration = this.var_180;
            }
            if(this.var_261 != null)
            {
            ...
            if(this.var_180)
            {
               ...
               {
                  this.var_637.configure(this.var_180);
               }
               if(this.var_635 != null)
               {
                  this.var_635.configure(this.var_180);
               }
               if(this.var_636 != null)
               {
                  this.var_636.configure(this.var_180);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_158);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_641,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_755,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_486,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_637 != null)
            {
               this.var_637.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_755)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1630);
         }
         else if(param1.type == HabboHotelViewEvent.const_486)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1451);
         }
         else if(param1.type == HabboHotelViewEvent.const_66)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1389);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_641:
               this.trackLoginStep(HabboLoginTrackingStep.const_1430,String(this._communication.port));
               break;
      ...
      {
         this.var_1188 = IHabboWindowManager(param2);
         if(this.var_1188)
         {
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboRoomSettingsTrackingEvent.HABBO_ROOM_SETTINGS_TRACKING_EVENT_CLOSED,this.method_3);
         this._navigator.events.addEventListener(HabboRoomSettingsTrackingEvent.HABBO_ROOM_SETTINGS_TRACKING_EVENT_DEFAULT,this.method_3);
         this._navigator.events.addEventListener(HabboRoomSettingsTrackingEvent.HABBO_ROOM_SETTINGS_TRACKING_EVENT_ADVANCED,this.method_3);
         this._navigator.events.addEventListener(HabboRoomSettingsTrackingEvent.HABBO_ROOM_SETTINGS_TRACKING_EVENT_THUMBS,this.method_3);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_199).events.addEventListener(HabboFriendListTrackingEvent.const_403,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_403:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1133,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_667,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_284.events.addEventListener(AdEvent.const_539,this.onRoomAdLoad);
      }
      ...
      {
         this.var_637.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1866;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1866);
         }
         if(this.var_517 > -1 && _loc2_ - this.var_517 > 15000)
         {
            ++this.var_1865;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1865);
         }
         this.var_517 = _loc2_;
         if(this.var_261 != null)
         {
            this.var_261.update(param1,this.var_517);
         }
         if(this.var_262 != null)
         {
            this.var_262.update(param1,this.var_517);
         }
         if(this.var_635 != null)
         {
            this.var_635.trackUpdate(param1,this,this.var_517);
         }
         if(this.var_637 != null)
         {
            this.var_637.update(this.var_517);
         }
      }
   }
}
