package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2811:String = "magic.credits";
      
      private var var_2767:String = "magic.pixels";
      
      private var var_2766:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         this.var_330 = [];
         this.var_57 = this._container.findChildByName("navigationList") as IItemListWindow;
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_694,this.deActivateScrollbar);
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in this._index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(this.var_57);
            }
         }
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_330.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_330)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_330.indexOf(_loc6_);
            this.var_330.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      {
         this.openPage(this.var_2767);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2766,true);
      }
