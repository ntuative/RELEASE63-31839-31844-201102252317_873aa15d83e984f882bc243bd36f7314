package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1974:int = 10;
      ...
      private const const_1673:uint = 4.293848814E9;
      
      private const const_1674:uint = 4.294967295E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1737 = _loc1_.stuffTypes;
            this.var_752 = _loc1_.boxTypes;
            this.var_753 = _loc1_.ribbonTypes;
            this.var_1144 = this.var_1737[0];
            this.var_356 = this.var_752[0];
            this.var_355 = this.var_753[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_355 < 0)
         {
            this.var_355 = this.var_753.length - 1;
         }
         if(this.var_355 > this.var_753.length - 1)
         {
            this.var_355 = 0;
         }
         if(this.var_356 < 0)
         {
            this.var_356 = this.var_752.length - 1;
         }
         if(this.var_356 > this.var_752.length - 1)
         {
            this.var_356 = 0;
         }
         var _loc1_:int = this.var_752[this.var_356] * 1000 + this.var_753[this.var_355];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1144,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1421 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1737;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_91);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1144);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_752[this.var_356]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_753[this.var_355]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_91,this.var_1420,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_91.offerId,this.var_1420);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               if(this.var_2555 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_206)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1974)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2555 = _loc3_.text;
               break;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_604 == null)
         {
            this.var_604 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_604.procedure = this.suggestionsEventHandler;
         }
         if(this.var_251 == null || this.var_604 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_604.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1673) : uint(this.const_1674);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1144;
               }
            }
            _loc4_++;
         }
