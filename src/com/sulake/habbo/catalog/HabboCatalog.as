package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_287:CatalogViewer;
      
      private var var_335:ICatalogNavigator;
      ...
      private var var_288:ChargeConfirmationDialog;
      ...
      private var var_2302:GiftWrappingConfiguration;
      
      private var var_1072:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_205.showOffer(this,param1,param2,param3,_loc4_);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._communication.addHabboConnectionMessageEvent(new HabboClubOffersMessageEvent(this.method_10));
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_335.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function include() : void
      {
         ...
         var _loc1_:* = this.var_180.getKey("client.credits.embed.enabled","IInventoryView") == "true";
         if(false && _loc1_)
         {
      ...
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_91)
         {
      ...
      {
         var _loc2_:Array = this.var_706.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_96.getActivityPointsForType(Purse.const_170)));
         var _loc1_:int = 0;
      ...
      {
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_287.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_287 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_287.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this.method_6("layoutBackground",_loc2_.content as BitmapData);
         var _loc3_:IWindowContainer = this._mainContainer.findChildByName("navigatorMain") as IWindowContainer;
         _loc3_.setParamFlag(WindowParam.const_220,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_90:
               this.var_1633 = param1.session.isPrivateRoom;
               if(this.var_89 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_123 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1072 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_335.buildCatalogIndex(_loc2_);
         if(this.var_705 && this.var_705 != "")
         {
            this.var_335.openPage(this.var_705);
            this.var_705 = "";
            this.var_867 = -1;
         }
         else if(this.var_867 > -1)
         {
            this.var_335.openPageById(this.var_867,this.var_1634);
            this.var_867 = -1;
            this.var_1634 = -1;
            this.var_705 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_287.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_287 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_287.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2303 && this.var_566 != null)
         {
            this.var_566.playSound(HabboSoundTypesEnum.const_1070);
         }
         this.var_2303 = false;
         if(this.var_288 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_70,this.var_96.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2304 && this.var_566 != null)
         {
            this.var_566.playSound(HabboSoundTypesEnum.const_1035);
         }
         this.var_2304 = false;
         if(this.var_288 != null)
         {
         ...
         if(_loc2_.type == Purse.const_170)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1072.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_287.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_123 != null)
         {
            this.var_123.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_123 != null)
         {
            this.var_123.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_123 != null)
         {
            this.var_123.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2302 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_123.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onMarketplaceMakeOfferResult(param1:MarketplaceMakeOfferResult) : void
      {
         ...
         if(_loc2_.result == 1)
         {
            this.var_123.refreshOffers();
         }
      }
      
      private function method_10(param1:HabboClubOffersMessageEvent) : void
      {
         if(this._clubBuyController != null)
         {
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_288 == null)
         {
            this.var_288 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_288.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_706.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_706.add(_loc2_.productCode,_loc3_.slice());
            this.var_287.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      
      private function method_6(param1:String, param2:BitmapData) : void
      {
