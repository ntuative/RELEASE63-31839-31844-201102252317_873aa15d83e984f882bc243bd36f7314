package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_578 != const_937;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1691 != RecyclerStatusMessageEvent.const_1155;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_578 == const_416;
      }
      ...
      {
         this.var_578 = const_936;
         this.var_112 = new Array(const_171);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1691)
         {
            case RecyclerStatusMessageEvent.const_1558:
               this.var_578 = const_416;
            ...
            case RecyclerStatusMessageEvent.const_1155:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1593:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1108:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1490:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_112.length < const_171)
         {
            return false;
         }
         var _loc1_:int = 0;
