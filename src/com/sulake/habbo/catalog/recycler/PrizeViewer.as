package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      {
         var _loc8_:* = null;
         this.var_281 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_281 != null && !this.var_281.disposed)
         {
            ...
            this.var_281.bitmap = new BitmapData(this.var_281.width,this.var_281.height,true,16777215);
            this.var_281.bitmap.fillRect(this.var_281.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_281.width - param1.width) / 2,(this.var_281.height - param1.height) / 2);
            this.var_281.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
