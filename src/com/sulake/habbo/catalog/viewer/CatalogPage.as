package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1186:ICatalogViewer;
      ...
      private var var_465:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1039:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_465 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1040);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1040);
      }
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1437:
               if(this.var_1039 == null)
               {
                  this.var_1039 = new ItemGridCatalogWidget(param1);
                  this.var_47.push(this.var_1039);
               }
               break;
            case CatalogWidgetEnum.const_1460:
            ...
            case CatalogWidgetEnum.const_1445:
               ...
               break;
            case CatalogWidgetEnum.const_1506:
            ...
            case CatalogWidgetEnum.const_1446:
               ...
               break;
            case CatalogWidgetEnum.const_1527:
            ...
            case CatalogWidgetEnum.const_1436:
               ...
               break;
            case CatalogWidgetEnum.const_1532:
               this.var_47.push(new RedeemItemCodeCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1632:
            ...
            case CatalogWidgetEnum.const_1497:
               ...
               break;
            case CatalogWidgetEnum.const_1452:
            ...
            case CatalogWidgetEnum.const_1432:
               ...
               break;
            case CatalogWidgetEnum.const_1427:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_465.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_465 != null)
         {
            return this.var_465.dispatchEvent(param1);
         }
         return false;
      }
   }
