package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1971:int = 40;
      
      private const const_1972:int = 10;
      
      private var var_723:Array;
      
      private var var_1368:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_488)
         {
            this.var_488.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_488 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_577)
         {
            ...
            this.var_577 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_577)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1692,_loc2_.length);
         if(!this.var_488)
         {
            this.var_488 = new Timer(25);
            this.var_488.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1093 = 0;
         this.populateList();
         this.var_488.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1093 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1093));
            ++this.var_1093;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_577 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_577.clone() as IWindowContainer;
         ...
         else if(param1.type == WindowEvent.const_107)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1972;
                  break;
               case "search_input":
                  _loc8_ = this.const_1971;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1368.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_57)
