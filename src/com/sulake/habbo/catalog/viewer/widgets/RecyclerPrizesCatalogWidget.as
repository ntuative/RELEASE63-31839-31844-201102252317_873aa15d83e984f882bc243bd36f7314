package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1186:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1863:XML;
      
      private var var_1864:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1864 = _loc1_.content as XML;
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1864) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1863) as IWindowContainer;
         param2.addGridItem(_loc3_);
         param2.height = param2.scrollableRegion.height;
         param1.view = _loc3_;
         param1.grid = this;
         param1.method_4(page.viewer.roomEngine);
      }
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1186.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
