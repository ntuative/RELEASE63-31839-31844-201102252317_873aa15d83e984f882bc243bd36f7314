package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1252:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_468 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_468 < 8)
         {
            return false;
         }
         this.var_2200 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_196 != null && this.var_196.length > 0)
         {
            this.var_325 = this.var_196[0];
         }
         else
         {
            this.var_325 = -1;
         }
         this._offers.add(this.var_468,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_196 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1252 && _loc2_ < this.var_196.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_468,this.var_196[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_196 != null && this.var_196.length > 0)
         {
            ...
            this.var_325 = this.var_196[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_468,this.var_325),this.getRaceLocalizationKey(this.var_468,this.var_325));
            }
         }
         return this.getRaceLocalizationKey(this.var_468,this.var_325);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_325 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_468;
         var _loc3_:int = this.var_325;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_325 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
