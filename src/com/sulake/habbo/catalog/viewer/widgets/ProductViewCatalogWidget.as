package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1350:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1083 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1670 = new Point(this.var_84.x,this.var_84.y);
         this.var_485 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1350 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_485 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1863 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         this.var_1669 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1083.text = _loc5_;
         this.var_889.height = this.var_889.textHeight + 5;
         this.var_1083.y = this.var_889.y + this.var_889.height;
         this.var_1083.height = Math.max(130,this.var_1083.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_562:
                  _loc6_ = this.var_1669.clone();
                  if(this.var_485 != null)
                  {
                     this.var_485.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_485,this.var_1350,this.var_1863);
                     this.var_485.scrollV = 0;
                  }
                  break;
               case Offer.const_555:
               case Offer.const_554:
                     ...
                     case ProductTypeEnum.const_241:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_283,AvatarAction.const_568);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2357)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2357 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1670.x;
            this.var_84.y = this.var_1670.y;
            if(param3 != null)
            {
