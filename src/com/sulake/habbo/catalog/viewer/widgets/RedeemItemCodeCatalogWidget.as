package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_839:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_838.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_838 = null;
         }
         if(this.var_839 != null)
         {
            this.var_839.removeEventListener(WindowKeyboardEvent.const_173,this.windowKeyEventProcessor);
            this.var_839 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_838 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_838 != null)
         {
            this.var_838.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_839 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_839 != null)
         {
            this.var_839.addEventListener(WindowKeyboardEvent.const_173,this.windowKeyEventProcessor);
         }
         return true;
      }
