package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1623:String = "default";
      ...
      private var var_1624:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
               ...
               switch(_loc4_.furnitureData.name)
               {
                  ...
                  case "landscape":
                     for each(_loc11_ in this.var_180.landscapes.pattern)
                     {
                        ...
                        {
                           this.var_860.push(_loc7_);
                           _loc8_ = true;
                        }
                     }
                     if(_loc8_)
                     {
                        this.var_1320.push(_loc2_);
                     }
                     else
                     {
            ...
            this.changePattern(const_202,0);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1321[this.var_398];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1623);
               }
               break;
            case "ctlg_floor_pattern_prev":
               this.changePattern(const_202,-1);
               break;
            case "ctlg_floor_pattern_next":
               this.changePattern(const_202,1);
               break;
            case "ctlg_floor_color_prev":
               this.changeColor(const_202,-1);
               break;
            case "ctlg_floor_color_next":
               this.changeColor(const_202,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1322[this.var_395];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1320[this.var_396];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1624);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_858[this.var_398];
         for each(_loc1_ in this.var_180.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_397 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_397];
                  if(_loc9_ != null)
                  {
                     this.var_1623 = _loc9_.@id;
                  }
               }
            }
         }
         ...
         var _loc5_:String = this._activeFloorPatterns[this.var_395];
         ...
         _loc6_ = this.var_1322[this.var_395];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_860[this.var_396];
         for each(_loc1_ in this.var_180.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               ...
               if(_loc13_ != null)
               {
                  this.var_1624 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1320[this.var_396];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_203:
               ...
               if(this.var_398 < 0)
               {
                  this.var_398 = this.var_858.length - 1;
               }
               if(this.var_398 == this.var_858.length)
               {
                  this.var_398 = 0;
               }
               this.var_397 = 0;
               this.var_861 = 0;
               _loc5_ = this.var_858[this.var_398];
               for each(_loc8_ in this.var_180.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_861 = _loc8_.children().length();
                  }
               }
            ...
            case const_202:
               ...
               if(this.var_395 < 0)
               {
                  this.var_395 = this._activeFloorPatterns.length - 1;
               }
               if(this.var_395 >= this._activeFloorPatterns.length)
               {
                  this.var_395 = 0;
               }
               this.var_475 = 0;
               this.var_859 = 0;
               _loc6_ = this._activeFloorPatterns[this.var_395];
               for each(_loc9_ in this.var_180.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_859 = _loc9_.children().length();
                  }
               }
            ...
            case const_96:
               ...
               if(this.var_396 < 0)
               {
                  this.var_396 = this.var_860.length - 1;
               }
               if(this.var_396 >= this.var_860.length)
               {
                  this.var_396 = 0;
               }
               this.var_474 = 0;
               this.var_862 = 0;
               _loc7_ = this.var_860[this.var_396];
               for each(_loc10_ in this.var_180.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_862 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1623,this.var_1624,64,this,"window_romantic_wide");
         ...
         {
            this.var_1625 = _loc2_.id;
            this.var_1622 = _loc3_.id;
