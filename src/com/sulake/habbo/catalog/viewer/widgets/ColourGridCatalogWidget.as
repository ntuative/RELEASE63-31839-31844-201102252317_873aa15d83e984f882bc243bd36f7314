package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_411 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_907 = _loc4_.content as BitmapData;
         _loc5_ = page.viewer.catalog.assets.getAssetByName(param1.chosenColourAssetName) as BitmapDataAsset;
         this.var_834 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_411.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         for each(_loc2_ in param1.colours)
         {
            this.var_906.push(_loc2_.slice());
         }
         _loc3_ = page.viewer.catalog.assets.getAssetByName(param1.backgroundAssetName) as BitmapDataAsset;
         this.var_585 = _loc3_.content as BitmapData;
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.colourAssetName) as BitmapDataAsset;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_906.length,this.var_411.numGridItems]);
         this.var_411.destroyGridItems();
         this.var_336 = null;
         for each(_loc1_ in this.var_906)
         {
            if(_loc1_.length > 0)
            {
               ...
               this.var_411.addGridItem(_loc2_);
               ...
               if(_loc4_ != null)
               {
                  _loc4_.bitmap = new BitmapData(this.var_907.width,this.var_907.height,true,0);
                  _loc6_ = 255;
                  _loc7_ = 255;
                  _loc8_ = 255;
                  _loc9_ = null;
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_834.width,this.var_834.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_834,this.var_834.rect,new Point(0,0),null,null,true);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_411.getGridItemIndex(param1.target as IWindow);
