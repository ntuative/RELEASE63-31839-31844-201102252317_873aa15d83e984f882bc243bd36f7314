package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_998 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_970 == page.offers.length)
            {
         ...
         while(_loc3_ < 3)
         {
            if(this.var_970 >= 0 && this.var_970 < page.offers.length)
            {
               _loc4_ = page.offers[this.var_970];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_562)
         {
            ++this.var_1883;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1883);
         }
      }
