package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      protected var var_998:IItemGridWindow;
      ...
      {
         super(param1);
         this.var_998 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      {
         this.var_1312 = param1.botFigureData;
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1863) as IWindowContainer;
         this.var_998.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = this.var_1312.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1607.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1312.getValue(this.var_699.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1607.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1312.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
