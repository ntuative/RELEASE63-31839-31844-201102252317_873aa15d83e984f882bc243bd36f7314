package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_959:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1037,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_958.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_514;
         _loc2_.play();
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_766.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_766,events);
         _loc8_.volume = this.var_514;
         this.var_959 = null;
         this.var_765 = -1;
         if(_loc5_.length != 0)
         {
      ...
      {
         if(this.var_180 == null || this._connection == null || this._roomEngine == null || this.var_619 != null)
         {
            return;
         }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         this.var_766.add(_loc3_,_loc6_);
         if(this.var_618.length == 0 && this.var_765 != -1)
         {
            this.var_959.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1037,this.var_765));
            this.var_765 = -1;
            this.var_959 = null;
         }
      }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1365,this.var_765));
         this.var_765 = -1;
         this.var_959 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_514 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_514 * 100)));
         }
      }
      ...
      {
         this.var_514 = param1;
         this.var_619.updateVolume(this.var_514);
