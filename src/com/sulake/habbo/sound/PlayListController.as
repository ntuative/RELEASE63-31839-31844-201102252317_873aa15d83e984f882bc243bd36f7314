package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1708:String = "type_jukebox";
      
      private var var_566:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_880,this.onSongFinishedPlayingEvent);
         this.var_77.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_898,this.onSoundMachinePlayEvent);
         this.var_77.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_852,this.onSoundMachineStopEvent);
         this.var_77.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_739,this.onJukeboxInitEvent);
         this.var_77.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_573,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_880,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_77)
            {
               this.var_77.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_898,this.onSoundMachinePlayEvent);
               this.var_77.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_852,this.onSoundMachineStopEvent);
               this.var_77.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_739,this.onJukeboxInitEvent);
               this.var_77.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_573,this.onDisposeEvent);
               this.var_77 = null;
            }
            if(this.var_431)
            {
      ...
      {
         this.startPlaying(this.const_1708);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(this.var_80 == null || this.var_80.length == 0)
         {
         ...
         if(_loc2_ != null)
         {
            this.var_307 = _loc2_.id;
            this.playSong(this.var_307);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_431[this.var_307] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_431.getValue(this.var_307) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_307 = param1;
         var _loc2_:IHabboSound = this.var_431.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_566.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_566.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_307)
         {
            _loc6_ = this.var_431[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1855 == this.const_1708)
         {
            this.var_80.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function getNextEntry() : PlayListEntry
      {
         ...
         {
            _loc2_ = this.var_80[_loc3_];
            if(_loc2_.id == this.var_307)
            {
               _loc1_ = _loc3_ + 1;
            }
            _loc3_++;
         }
         if(_loc1_ >= this.var_80.length)
         {
            _loc1_ = 0;
         }
         return this.var_80[_loc1_];
      }
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_631.indexOf(param1) == -1)
         {
            this.var_631.push(param1);
         }
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_80.length)
            {
               _loc6_ = this.var_80[_loc5_] as PlayListEntry;
               if(_loc6_.id == _loc3_.id)
               {
                  this.var_80.splice(_loc5_,1);
                  _loc4_ = false;
                  break;
               }
               _loc5_++;
         ...
         this.var_631 = this.var_631.splice(this.var_631.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_431[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_566.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_431.add(_loc3_.id,_loc7_);
            }
