package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_697 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_695 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_696 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_143 != null)
         {
            ...
            {
               _loc2_ = this.var_143.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_143.getValue(param1);
      ...
      {
         var _loc4_:* = null;
         if(this.var_697.hasItem(param1))
         {
            this.var_697.getItem(param1).answerText = param2;
         }
         if(this.var_695.hasItem(param1))
         {
            this.var_695.getItem(param1).answerText = param2;
         }
         if(this.var_696.hasItem(param1))
         {
            this.var_696.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_143.length)
         {
            _loc4_ = this.var_143.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_697.hasItem(param1))
         {
            return this.var_697.getItem(param1);
         }
         if(this.var_695.hasItem(param1))
         {
         ...
         if(this.var_696.hasItem(param1))
         {
            return this.var_696.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_143.length)
         {
            _loc3_ = this.var_143.getWithIndex(_loc2_);
