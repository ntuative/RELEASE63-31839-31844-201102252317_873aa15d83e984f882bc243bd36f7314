package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_337 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102252305));
         this.var_181 = param5;
         this.var_110 = new Map();
         this.var_110.add(HabboHelpViewEnum.const_1544,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_110.add(HabboHelpViewEnum.const_184,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_110.add(HabboHelpViewEnum.const_474,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_110.add(HabboHelpViewEnum.const_296,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_110.add(HabboHelpViewEnum.const_216,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_110.add(HabboHelpViewEnum.const_376,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_110.add(HabboHelpViewEnum.const_671,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_110.add(HabboHelpViewEnum.const_213,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_110.add(HabboHelpViewEnum.const_980,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_110.add(HabboHelpViewEnum.const_1146,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_110.add(HabboHelpViewEnum.const_810,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_110.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_110.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_478.length == 0 || param1 != this.var_337)
            {
               this.var_478.push(this.var_337);
            }
         }
         this.var_337 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_337);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_213:
               this.showUI(HabboHelpViewEnum.const_213);
               break;
            case CallForHelpResultEnum.const_1004:
               this.showUI(HabboHelpViewEnum.const_1146);
               break;
            case CallForHelpResultEnum.const_1158:
               this.showUI(HabboHelpViewEnum.const_980);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_110.getValue(HabboHelpViewEnum.const_184) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_505));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_110.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_110.getValue(this.var_337);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2316 = this._window.width - _loc4_.width;
         this.var_2315 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2315;
         this._window.width = _loc1_.width + this.var_2316;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_337 == HabboHelpViewEnum.const_184)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_338.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_337 == HabboHelpViewEnum.const_184 || this.var_478.length == 0)
         {
            return;
         }
         if(this.var_338 == null)
         {
            ...
            this.var_338 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_338.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_338.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_338 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_338 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_338 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
