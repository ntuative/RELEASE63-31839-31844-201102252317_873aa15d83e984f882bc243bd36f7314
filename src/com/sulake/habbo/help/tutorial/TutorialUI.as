package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_505,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_544,this.onTaskDoneEvent);
         ...
         {
            this.var_33.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_285,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1087 && this.var_1086 && this.var_1360;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_505,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_544,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_488,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
               this.var_33.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_285,this.onFigureUpdate);
            }
            this.var_33 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_43 == null || this.var_43.id == const_85)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_505:
               this.var_1360 = true;
               if(this.var_43 != null && this.var_43.id == const_519)
               {
                  this.showView(const_85);
               }
               break;
            case HabboHelpTutorialEvent.const_544:
               if(this.var_43 != null && this.var_43.id == const_377)
               {
                  this.var_1682 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2316 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2315;
         this._window.width = _loc2_.width + this.var_2316;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_33.hideUI();
         this.var_33.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_117));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_43 != null && (this.var_43.id == const_316 || this.var_43.id == const_85))
         {
            this.showView(const_85);
         }
      }
      ...
      {
         this.var_1087 = true;
         if(this.var_43 != null && (this.var_43.id == const_377 || this.var_43.id == const_85))
         {
            this.showView(const_85);
         }
      }
