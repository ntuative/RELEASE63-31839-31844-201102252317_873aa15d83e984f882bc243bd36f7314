package com.sulake.habbo.help.register
{
   ...
   public class RegistrationView
   {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_43.findChildByName("registration_email_address") as ITextFieldWindow;
            _loc4_ = this.var_43.findChildByName("registration_new_password") as ITextFieldWindow;
            _loc5_ = this.var_43.findChildByName("registration_terms_checkbox") as ICheckBoxWindow;
            _loc6_ = this.var_43.findChildByName("registration_merketing_checkbox") as ICheckBoxWindow;
            _loc7_ = this.var_43.findChildByName("registration-email-address-error") as ITextWindow;
            _loc8_ = this.var_43.findChildByName("registration-new-password-error") as ITextWindow;
            _loc7_.text = "";
            _loc8_.text = "";
