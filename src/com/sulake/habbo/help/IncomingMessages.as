   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_194)
            {
               this._component.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_2135 = _loc5_.id;
            }
            _loc4_++;
         }
         this._component.tellUI(HabboHelpViewEnum.const_810);
      }
      ...
      {
         this._component.showUI(HabboHelpViewEnum.const_376);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_184);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_296,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this._component.tellUI(HabboHelpViewEnum.const_216,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_1099);
         this._component.tellUI(HabboHelpViewEnum.const_1099,_loc5_);
      }
