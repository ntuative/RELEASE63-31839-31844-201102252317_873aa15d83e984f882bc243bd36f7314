package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      {
         this.var_77 = param2;
         this.var_1201 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1201.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1201.setValue(1);
         this.var_1200 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1200.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1200.setValue(50);
      }
