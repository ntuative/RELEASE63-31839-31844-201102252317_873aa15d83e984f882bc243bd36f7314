package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1356:int = 2;
      ...
      private var var_1676:TriggerConfs;
      
      private var var_1675:ActionTypes;
      
      private var var_1677:ConditionTypes;
      ...
      {
         this.var_1676 = new TriggerConfs();
         this.var_1675 = new ActionTypes();
         this.var_1677 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1085 = new SliderWindowController(this.var_77,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_77.assets,0,20,1);
         this.var_1085.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1085.setValue(0);
         this.method_4("configure_container","icon_trigger","trigger_icon_bitmap");
         this.method_4("configure_container","icon_action","action_icon_bitmap");
         this.method_4("configure_container","icon_condition","condition_icon_bitmap");
      ...
      private function method_4(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_718.hideAll(this.var_243);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1085.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1356) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1356 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1676);
         this.refreshConfigureElement(this.var_1675);
         this.refreshConfigureElement(this.var_1677);
