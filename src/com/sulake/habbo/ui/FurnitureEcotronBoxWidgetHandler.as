package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_760,RoomWidgetEcotronBoxOpenMessage.const_675,RoomWidgetEcotronBoxOpenedMessage.const_1536];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_760:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_675:
