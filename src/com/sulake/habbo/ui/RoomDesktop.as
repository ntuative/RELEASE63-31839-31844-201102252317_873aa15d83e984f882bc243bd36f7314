package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1063:IRoomWidgetFactory = null;
      ...
      private var var_192:DesktopLayoutManager;
      ...
      private var var_2323:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_192 = new DesktopLayoutManager();
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_306,this.processEvent);
         }
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_404,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_463,this.onRoomContentLoaded);
      ...
      {
         this.var_192.setLayout(param1,this._windowManager);
         if(this.var_181 != null)
         {
            this.var_192.toolbarSize = this.var_181.size;
            this.var_192.toolbarOrientation = this.var_181.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_480 != null)
         {
            ...
            {
               _loc6_ = this.var_480.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_306,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_404,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_463,this.onRoomContentLoaded);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_30 != null)
         {
            this.var_710 = this._roomEngine.loadRoomResources(this.var_30.roomResources);
         ...
         if(this.var_284 != null && this.var_30.state == RoomSessionEvent.const_215)
         {
            this.var_1656 = !this.var_284.showInterstitial();
         }
      ...
      {
         if(this.var_710 == null || this.var_710.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_710.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1063.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_192.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!this.var_480.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_711.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_711.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_712.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_712.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,this.var_192.roomViewRect);
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_871:
               ...
               if(this.var_851 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc7_ = this.var_30.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_194)
                  {
                     this.var_851.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_433:
               ...
               break;
            case RoomEngineObjectEvent.const_874:
               if(!this.var_30.isRoomController && !this.var_409.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_125:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1163,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_499:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_378,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_192.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_886);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_791);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_763);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_858);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_289,this.canvasMouseHandler);
         ...
         this.var_192.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2323);
      ...
      {
         var _loc3_:IWindowContainer = this.var_192.method_14() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_192.roomViewRect;
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_30.roomId,this.var_30.roomCategory,this.var_289[0],_loc2_.width,_loc2_.height);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.var_192.toolbarOrientation = param1.orientation;
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1657) / 1000);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < this.var_480.length)
         {
            _loc2_ = this.var_480.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         if(this.var_15 != null && this.var_30 != null && this.var_1656 && this.var_1655)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_478:
               ...
               this.var_207 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_384,WindowStyle.const_901,WindowParam.const_95) as IToolTipWindow;
