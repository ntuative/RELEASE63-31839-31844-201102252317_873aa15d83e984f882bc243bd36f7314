   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_155,this.onFigureUpdate);
         ...
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_155,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_553.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_553.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_863);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_800);
         ...
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_774);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1509);
         _loc1_.push(RoomWidgetPetCommandMessage.const_525);
         _loc1_.push(RoomWidgetPetCommandMessage.const_726);
         _loc1_.push(RoomWidgetUserActionMessage.const_537);
         _loc1_.push(RoomWidgetUserActionMessage.const_382);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_714);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_534)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_382 || param1.type == RoomWidgetUserActionMessage.const_537 || param1.type == RoomWidgetUserActionMessage.const_447)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_685:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1201,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_770:
               ...
               break;
            case RoomWidgetUserActionMessage.const_863:
            ...
            case RoomWidgetGiveBadgeMessage.GIVE_BADGE:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_800:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_749:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_774:
            ...
            case RoomWidgetUserActionMessage.const_657:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_726:
            ...
            case RoomWidgetPetCommandMessage.const_525:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_714:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_276);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_383);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1112);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1216);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_180)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_194)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_732)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_538);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_122)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_146)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_677);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1065;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1110;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1444);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_553.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_553.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_677);
