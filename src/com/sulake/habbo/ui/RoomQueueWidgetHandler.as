package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_697);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_831);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1044);
               break;
            case RoomWidgetRoomQueueMessage.const_697:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_985);
               break;
            case RoomWidgetRoomQueueMessage.const_831:
      ...
      {
         return [RoomSessionQueueEvent.const_446];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_446:
               ...
               {
                  case RoomSessionQueueEvent.const_985:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_1044:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_1056) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1056) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1504) + 1;
                  }
               }
               else
               {
