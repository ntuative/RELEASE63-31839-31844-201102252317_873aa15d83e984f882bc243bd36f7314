   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_784,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_794,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_181 != null)
            {
               this.var_181.events.removeEventListener(HabboToolbarEvent.const_68,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_422,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_784,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_794,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_422,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1292)
            {
               ...
               this.var_1558 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1558;
            }
         }
         if(this.var_181 != null)
         {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_639);
         ...
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_342);
         _loc1_.push(RoomWidgetStopEffectMessage.const_652);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1557);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1066);
         _loc1_.push(RoomWidgetToolbarMessage.const_740);
         _loc1_.push(RoomWidgetToolbarMessage.const_643);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_405);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1573);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1217);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_792);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_716);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_821);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1619);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_622);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_772:
               ...
               break;
            case RoomWidgetDanceMessage.const_639:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_668:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_342:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1132)
               {
            ...
            case RoomWidgetSetToolbarIconMessage.const_1148:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1524:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_1066:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_792:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_643:
               ...
               {
                  this.var_181.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_530,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_405:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_544));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_821:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_357,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_622:
            ...
            case RoomWidgetClothingChangeMessage.const_359:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_690));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_422:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_536));
         }
      }
