package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1780:Map = null;
      
      private var var_1136:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1137:Number = 0.0;
      
      private var var_747:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_414 != null)
         {
            ...
            {
               _loc2_ = this.var_414.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_731,RoomWidgetChatSelectAvatarMessage.const_635];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_731:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1198))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1198))
                              {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_180)
                           {
                              _loc13_ = this.var_300.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_414.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_595.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_180:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_595.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_414.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1137 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1137);
            }
            if(this.var_747 == null)
            {
               ...
               this.var_504.y = 0;
               this.var_504.z = 0;
               this.var_747 = _loc4_.getScreenPoint(this.var_504);
               this.var_1137 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_504.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_747.x || _loc8_.y != this.var_747.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_747,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_414)
         {
            _loc2_ = this.var_414.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1136.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_595.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1780.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1780.remove(param1);
         if(_loc3_ != null)
         {
