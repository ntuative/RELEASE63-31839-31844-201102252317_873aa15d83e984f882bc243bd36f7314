package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_790:int = 70;
      
      public static const const_528:int = 4;
      
      private static const name_2:int = 0;
      
      private static const const_531:int = 1;
      
      private static const const_960:int = 2;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1859 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1859 = 15;
         }
         this.var_1858 = this._window.height;
         this.var_773 = 4;
         this.var_774 = 0;
         this._state = name_2;
         this.var_181 = param5;
      ...
      {
         if(param1.badgeId != this.var_215.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_531:
               ...
               _loc2_ = Number(this.var_1183) / Number(this.var_432["time_fade_in"]);
               if(this.var_1183 > int(this.var_432["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_960:
               ...
               if(this.var_1454 > int(this.var_432["time_display"]) && !this.var_1857)
               {
                  this.startFadeOut();
               }
               break;
            case const_959:
               ...
               _loc3_ = 1 - Number(this.var_1182) / Number(this.var_432["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1182 > int(this.var_432["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1859;
         if(this._window.height < this.var_1858)
         {
            this._window.height = this.var_1858;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_181.orientation == "TOP" ? int(const_417) : 0;
         var _loc4_:int = this.var_181.orientation == "BOTTOM" ? int(_loc2_.height - const_417) : int(_loc2_.height);
         var _loc5_:int = this.var_181.orientation == "LEFT" ? int(const_417) : 0;
         var _loc6_:int = this.var_181.orientation == "RIGHT" ? int(_loc2_.width - const_417) : int(_loc2_.width);
         if(this.var_432["position_horizontal_follow_toolbar"] == "true" && (this.var_181.orientation != "TOP" && this.var_181.orientation != "BOTTOM"))
         {
         ...
         else if(this.var_432["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_528;
         }
         else
         ...
         if(this.var_432["position_vertical_follow_toolbar"] == "true" && (this.var_181.orientation != "RIGHT" && this.var_181.orientation != "LEFT"))
         {
            if(this.var_181.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_773;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_773;
            }
         }
         else if(this.var_432["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_773;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_774;
      }
   }
}
