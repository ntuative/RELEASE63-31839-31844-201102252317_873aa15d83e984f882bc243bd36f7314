package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1697:String = "badge_bg_001_png";
      
      private const const_1973:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1376 = param7;
         this.var_2418 = param5;
         this.var_1709 = param6;
         this.var_78 = param10;
         this._assets = param8;
         this.var_409 = param13;
         ...
         this._window.center();
         this.var_2421 = this.var_78.getBadgeName(this.var_295);
         this.var_2419 = this.var_78.getBadgeDesc(this.var_295);
         this.var_2417 = this.var_78.getAchievementNameForFacebook(this.var_295,this.var_409.userName,this.var_409.realName,this.var_1377);
         this.var_2422 = this.var_78.getAchievementDescForFacebook(this.var_295,this.var_409.userName,this.var_409.realName,this.var_1377);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2416 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_78.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1621.toString());
         this.var_78.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1376.toString());
         this.var_78.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1376.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1709;
         var _loc17_:String = this.var_1709 == 0 ? "pixels" : "activitypoints";
         this.var_78.registerParameter(_loc16_,_loc17_,"" + this.var_2418);
         _loc15_.caption = this.var_78.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1697);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1973) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_78.registerParameter(param1,"badge_name",this.var_2421);
         this.var_78.registerParameter(param1,"badge_desc",this.var_2419);
         this.var_78.registerParameter(param1,"badge_name_fb",this.var_2417);
         this.var_78.registerParameter(param1,"badge_desc_fb",this.var_2422);
         this.var_78.registerParameter(param1,"level",this.var_1377.toString());
         this.var_78.registerParameter(param1,"name",this.var_409.userName);
         return this.var_78.registerParameter(param1,"realname",this.var_409.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_409.events.removeEventListener(BadgeImageReadyEvent.const_151,this.onBadgeImageReady);
            this.var_409 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1697);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_295,this._feedTitleFb,this.var_2416,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2420));
