package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1344:Number = 25;
      
      private static const const_1363:Number = 90;
      
      private static const const_958:int = 50;
      
      private static const const_1345:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1453:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_630 = new Object();
         this.var_629 = new Array();
         this.var_628 = new Array();
         super();
         this._windowManager = param1;
         this.var_1453 = param2;
         this.var_772 = new Timer(const_1344);
         this.var_772.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_365[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_958 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_958 || param1.desktop.height - param1.y < const_1345;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1453.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_365.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1453.getIconLoc(param1.iconId);
      ...
      {
         return this.var_629[this.var_628.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_628[this.var_629.indexOf(param1)];
      }
      ...
      private function method_9(param1:MenuAnimatorItem) : void
      {
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_628.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_628.splice(_loc3_,1);
            this.var_629.splice(_loc3_,1);
         }
         this.var_629.push(param1.name);
         this.var_628.push(param2);
         param1.addEventListener(WindowEvent.const_335,this.windowEventListener);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_630[_loc3_] == null)
            {
               this.var_630[_loc3_] = new Array();
            }
            if(this.var_630[_loc3_].indexOf(param1) < 0)
            {
               this.var_630[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_365.indexOf(param1) > -1)
         {
            if(const_210)
            {
            ...
            else
            {
               ...
               this.var_365.splice(this.var_365.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_629.length)
         {
            if(this.var_629[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_628[_loc2_];
               if(this.var_630[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_630[_loc3_].length)
                  {
                     this.repositionWindow(this.var_630[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_365.length)
         {
            _loc2_ = this._itemList[this.var_365[_loc7_]];
            if(_loc2_.active)
            {
