package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1450:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","IInventoryView") == "true")
         {
            this.var_1450 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_128,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1006,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_984,this.onHideWindowEvent);
         this._state = true;
      ...
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         ...
         if(this._view != null && this._state)
         {
            ...
            {
               this._view.method_4(param1.iconId);
            }
         }
      }
