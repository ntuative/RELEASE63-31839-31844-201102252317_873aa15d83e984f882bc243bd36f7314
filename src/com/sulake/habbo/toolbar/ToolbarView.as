package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_505:String = "LEFT";
      ...
      private var var_1417:Number = 0;
      
      private var var_1789:Number = 15;
      
      private var var_1790:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2785 = new Array();
         ...
         this.var_220 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_61,HabboWindowStyle.const_1086,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1141 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1141)
         {
         ...
         this.var_1417 = _loc6_.toolbar.@margin_bottom;
         this.var_1789 = _loc6_.toolbar.@min_group_margin;
         this.var_1790 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_296 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_248,param1,param2,this._window,this.var_296);
         this.createGroupsFromXmlList(_loc8_,this.var_597,param1,param2,this.var_220,this.var_296);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_156,this.var_505,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_505);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_156,this.var_505);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_156,this.var_505);
         }
      }
      
      public function method_4(param1:String, param2:Boolean = true) : void
      {
         var _loc3_:ToolbarIconGroup = this.getGroupForIcon(param1);
         if(_loc3_ != null)
         {
            _loc3_.method_4(param1,param2);
            this.alignWindows();
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_220 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_220.x = this.var_156 + this.var_1790;
               this.var_220.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_220.x = 0;
               this.var_220.y = this.var_156 + this.var_1790;
         ...
         else
         {
            ...
            if(this.var_248.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1789,(this._window.height - _loc5_ * _loc8_ - this.var_1142 - this.var_1417) / (this.var_248.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1789,(this._window.width - _loc5_ * _loc8_ - this.var_1142 - this.var_1417) / (this.var_248.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_248.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_505;
