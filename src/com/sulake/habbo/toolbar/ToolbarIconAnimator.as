package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_910.push(_loc11_);
                  this.var_912.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_910.push(new XML());
               this.var_912.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_912[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1394 == true || this.var_911 == 0)
         {
      ...
      {
         return this.var_910.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1394 == false && this.var_911 == 1 && this.var_1535 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_912.length)
         {
            _loc2_ = this.var_912[this._frame];
