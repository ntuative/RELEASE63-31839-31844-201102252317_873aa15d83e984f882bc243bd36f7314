package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_2061:int = 5;
      
      private var var_2063:int;
      
      private var var_156:Number;
      
      private var var_2064:XML;
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2064.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         return this.var_660.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1263.length)
         {
            _loc2_ = this.var_660.indexOf(this.var_1263[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_276[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1002 + _loc3_);
                  _loc3_ += this.var_1262;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_276[this.var_660.indexOf(param1)];
      }
