package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_923:uint = 4284532064;
      
      private static const const_924:uint = 2577770;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1620 = this.createMinimizedWindow();
         }
         if(!this.var_2284)
         {
            return this.var_67;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_923) : uint(const_924);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_923) : uint(const_924);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_166)
            {
            ...
            this.var_393.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_581);
            this.var_393.show();
         }
