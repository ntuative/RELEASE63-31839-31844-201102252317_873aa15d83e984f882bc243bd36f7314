package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_805:int = 0;
      
      protected var var_650:BitmapData;
      
      protected var var_2392:int;
      
      protected var var_1489:Boolean;
      
      protected var var_1993:Boolean;
      
      protected var var_2758:BitmapData;
      
      private const const_1964:int = 8947848;
      
      private const const_1963:int = 13421772;
      
      private const const_1706:Number = 1;
      
      private const const_1707:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2758 = param6;
         this.var_1993 = param7;
         this._items = new Map();
         this._mainCategory = param2;
         this._category = param3;
         this.var_1994 = param8;
         this.var_1304 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1304));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1994);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_762)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1707;
               _loc1_.blend = this.const_1707;
            }
            else
            {
               this._window.blend = this.const_1706;
               _loc1_.blend = this.const_1706;
            }
         }
         if(this.isSelected)
         {
            this._window.color = this.const_1964;
         }
         else
         {
         ...
         if(_loc5_)
         {
            if(this.var_1993 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2758;
               _loc5_.visible = true;
            }
            else
            {
