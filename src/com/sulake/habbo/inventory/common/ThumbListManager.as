package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1436:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_613 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_613.width;
         this.var_90 = this.var_613.height;
         this.var_1161 = param5;
         this.var_951 = param6;
         this.var_221 = Math.floor(this.var_1161 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1161,this.var_951);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_612 = this.resolveRowCountFromList();
         if(this.var_612 == 0)
         {
            this.var_26 = new BitmapData(this.var_1161,this.var_951);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_221 * this._thumbWidth,this.var_1161),Math.max(this.var_612 * this.var_90,this.var_951),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_612)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_221)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_221 && this.var_26.height < _loc3_.y * this.var_90)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_221 - 1),this.var_90);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_221 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_90),null,null,true);
         _loc4_ = new Rectangle(0,this.var_90,this._thumbWidth * (this.var_221 - 1),this.var_26.height - this.var_90);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1436.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_221));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_221 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_221);
         var _loc3_:int = param1 % this.var_221;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_221)
         {
            return;
         }
         if(param1.y >= this.var_612)
         {
            return;
         }
         var _loc4_:int = this.var_221 - param1.x - 1;
         ...
         if(this.var_26.height < this.var_951)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_951);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_613.width,this.var_613.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_613.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_613,this.var_613.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
