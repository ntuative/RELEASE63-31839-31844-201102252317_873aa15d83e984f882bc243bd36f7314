package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_905:int = 1;
      
      private const const_1685:int = 2;
      
      private const const_1683:int = 3;
      
      private const const_1684:int = 42;
      
      private const const_1686:int = 120;
      ...
      private var var_781:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_390.add(FurniModel.const_44,new FurniGridView(this.var_65,FurniModel.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_390.add(FurniModel.const_49,new FurniGridView(this.var_65,FurniModel.const_49,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_390.getValue(this.var_389);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_65.getCategoryContent(this.var_389);
         if(!this.var_65.isListInited())
         {
            _loc2_ = this.const_905;
         }
         ...
         if(this.var_2177 == _loc2_)
         {
            return;
         }
         this.var_2177 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_390.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_390.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_390.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function method_1() : void
      {
         ...
         _loc4_ = this.var_65.getGroupItemInIndex(_loc3_,this.var_389);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_393)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_166)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_781 && this.var_781.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1686)
         {
            _loc3_ = this.const_1686;
         }
         else if(_loc3_ < this.const_1684)
         {
            _loc3_ = this.const_1684;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_380);
            }
         }
      }
   }
