package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_380:String = "pets";
      
      private static const const_1266:int = 100;
      ...
      private var var_189:Timer;
      
      private var var_2268:XML;
      ...
      private var var_1613:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_217,this.onObjectPlaced);
         this._catalog = param7;
         this.var_560 = new Timer(const_1266,1);
         this.var_560.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2268 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_217,this.onObjectPlaced);
               }
            ...
            {
               this.var_560.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_560.stop();
               this.var_560 = null;
            }
            if(this.var_189 != null)
            {
               this.var_189.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_189.stop();
               this.var_189 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_44)
            {
               ...
               {
                  this.var_1613 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1613;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_393)
         {
         ...
         if(this.var_855 == null)
         {
            this.var_855 = this._windowManager.buildFromXML(this.var_2268) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_855.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_189 = new Timer(param1,1);
            this.var_189.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_189.start();
         }
         else
         {
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_559.add(const_44,new Array());
         this.var_559.add(const_49,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_166)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_397 || _loc3_.category == FurniCategory.const_393 || _loc3_.category == FurniCategory.const_354)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1316 && param1.type == RoomEngineObjectEvent.const_217)
         {
            this.var_1316 = false;
         }
      }
      ...
      {
         return this.var_559.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_559.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_762)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
