package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_57 = IItemListWindow(this._view.getChildByName("achievements_itemlist"));
         this.var_400 = new Timer(1000,1);
         this.var_400.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_409.events.addEventListener(BadgeImageReadyEvent.const_151,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_400)
            {
               this.var_400.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_400.reset();
               this.var_400 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_400.running);
         this.var_1075[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1075[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_409.getBadgeImage(param2.badgeId);
            this.var_1075[param2.badgeId] = _loc4_;
         }
