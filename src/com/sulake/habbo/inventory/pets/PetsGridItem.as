package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_43:
               this.var_1407.setSelectedGridItem(this);
               this.var_1408 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1408 = false;
                  this.var_1407.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1964) : uint(this.const_1963);
      }
