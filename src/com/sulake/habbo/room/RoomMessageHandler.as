package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_12 != null)
         {
            this.var_12.method_11(_loc3_.roomId,_loc3_.roomCategory,_loc4_);
         }
         if(this.var_1576)
         {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_682.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_682.objectData);
            this.var_682.objectData = null;
         }
         else
         {
            this.var_682.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_682.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_682.objectData = _loc6_;
         }
      }
