package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_764:String = "RCL_LOADER_READY";
      
      private static const const_327:String = "RCL_PUBLICROOM_";
      
      private static const const_1675:int = 0;
      ...
      private static const const_585:String = "wall_place_holder";
      ...
      private static const const_904:String = "selection_arrow";
      ...
      private var var_832:Map = null;
      
      private var var_385:Dictionary;
      
      private var var_833:Map = null;
      
      private var var_187:PublicRoomData = null;
      
      private var var_1281:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2104 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2103 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2101 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2102 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_409.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_461 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_461.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_670.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_384.add(_loc3_,_loc4_);
            ...
            _loc8_ = this.var_545.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_545.remove(_loc7_);
               this.var_545.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2105)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_764));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_462 != null)
         {
            this.var_462.remove(param2);
            this.var_462.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_460 != null)
         {
            _loc2_ = this.var_460.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_462 != null)
         {
            _loc2_ = this.var_462.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         return [const_412,const_585,const_584,const_583,TILE_CURSOR,const_904];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_384.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_544.getValue(param1) as String;
      ...
      {
         return this.var_832.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_833[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_544.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      {
         if(this.var_187 != null && this.var_187.hasWorldType(const_327 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_201 || param1 == RoomObjectVisualizationEnum.const_72 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_545.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2102 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_404,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_187 = this.var_1281.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_728,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2104.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1511);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_385[_loc5_] != null)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_385[param1];
            this.var_833.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1281.add(param1,_loc4_);
         this.var_187 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_669.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_669.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_461.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_669.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_461.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_461.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_263 && _loc5_ != RoomObjectLogicEnum.const_201)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(this.getObjectCategory(const_327 + param1) == RoomObjectCategoryEnum.const_75)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_187.getWorldHeightScale(const_327 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_187 != null)
         {
            return this.var_187.getWorldScale(const_327 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_384.add(param1,param2);
      }
   }
}
