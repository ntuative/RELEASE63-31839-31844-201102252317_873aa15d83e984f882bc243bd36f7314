package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1052,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_832,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_684,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_879,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1198)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1791;
            if(_loc2_ - this.var_1198 >= this.var_1891)
            {
               _loc3_ = this.var_1199;
               _loc4_ = this.var_1893;
               this.var_1198 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1199 >> 16 & 255;
               _loc11_ = this.var_1199 >> 8 & 255;
               _loc12_ = this.var_1199 & 255;
               _loc13_ = (_loc2_ - this.var_1198) / this.var_1891;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1892 + (this.var_1893 - this.var_1892) * _loc13_;
               this._color = _loc3_;
               this.var_1791 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_738:
               param2.setString(RoomObjectVariableEnum.const_779,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_900:
               param2.setString(RoomObjectVariableEnum.const_785,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_825:
               param2.setString(RoomObjectVariableEnum.const_695,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_547:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_231)
               {
                  _loc5_ = "null";
               }
               this.var_473.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_654:
               _loc4_ = this.var_473.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_473.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1023,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1215:
               param2.setNumber(RoomObjectVariableEnum.const_879,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1130,int(param1.bgOnly));
         this.var_1465 = this._color;
         this.var_1892 = this.var_1791;
         this.var_1199 = _loc3_;
         this.var_1893 = _loc4_;
         this.var_1198 = getTimer();
         this.var_1891 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_490,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1542,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1498,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1401,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_490,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_177)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_165 || _loc13_ == RoomPlaneData.const_301)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
