      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               ...
               {
                  case "start_stop":
                     _loc6_ = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_142,_loc3_,_loc4_,1);
                     break;
                  case "reset":
                     _loc6_ = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_142,_loc3_,_loc4_,2);
               }
         }
