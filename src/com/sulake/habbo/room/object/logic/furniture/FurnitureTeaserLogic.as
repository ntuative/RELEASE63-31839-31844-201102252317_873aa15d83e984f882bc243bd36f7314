package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_1955:String = "TYPE_INJECTED";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ == this.const_1955)
         {
            if(param1.type == MouseEvent.MOUSE_UP)
            {
               if(eventDispatcher != null)
               {
                  ...
                  _loc9_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_153,_loc7_,_loc8_);
         ...
         else if(param1.type == MouseEvent.DOUBLE_CLICK)
         {
            if(eventDispatcher != null)
            {
               _loc7_ = object.getId();
               _loc8_ = object.getType();
               _loc9_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_466,_loc7_,_loc8_);
               eventDispatcher.dispatchEvent(_loc9_);
            }
         }
