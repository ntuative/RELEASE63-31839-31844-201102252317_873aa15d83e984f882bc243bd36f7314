   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_744 != _loc2_)
         {
            ...
            if(_loc3_ * const_415 > const_943)
            {
               this.var_1081 = const_943 / _loc3_;
            }
            else
            {
               this.var_1081 = const_415;
            }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_744 && param1 >= this.var_1409 + this.var_1081)
            {
               _loc3_ = param1 - this.var_1409;
               _loc4_ = _loc3_ / this.var_1081;
               _loc5_ = 1;
               if(this.var_744 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1409 = param1 - (_loc3_ - _loc4_ * this.var_1081);
            }
         }
      }
   }
