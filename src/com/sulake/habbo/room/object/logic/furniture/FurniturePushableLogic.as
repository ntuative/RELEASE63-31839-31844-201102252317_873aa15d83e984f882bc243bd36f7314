package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_906:int = 0;
      
      private static const const_1676:int = 1;
      ...
      {
         super();
         moveUpdateInterval = const_683;
         this.var_1537 = new Vector3d();
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_683 / this.getUpdateIntervalValue(_loc3_.state);
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1537.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1537).length == 0)
            {
               if(object.getState(0) != const_906)
               {
                  object.setState(const_906,0);
               }
            }
         }
      }
