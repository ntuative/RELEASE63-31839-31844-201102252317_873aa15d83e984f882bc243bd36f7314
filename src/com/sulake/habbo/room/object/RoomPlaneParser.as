package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1116:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this._width = param1;
         this._height = param2;
         this.var_497 = this._width;
         this.var_496 = -1;
         this.var_494 = this._height;
         this.var_495 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this._width && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_497 || param1 == this.var_496)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_494;
               ...
               if(param2 == this.var_494 || param2 == this.var_495)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_497;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_945 = getFloorHeight(this.var_151);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_301,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1116);
         this.addPlane(RoomPlaneData.const_165,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_165,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_129) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_165,Vector3d.sum(param1,Vector3d.product(param3,-this.var_129 / param3.length)),Vector3d.product(param3,(param3.length + this.var_129) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1116 / param2.length);
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_177,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_177,_loc13_,new Vector3d(0,0,-this.var_129),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_177,_loc13_,new Vector3d(0,0,-this.var_129),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_177,_loc13_,new Vector3d(0,0,-this.var_129),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_177,_loc13_,new Vector3d(0,0,-this.var_129),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1139;
         }
         var _loc2_:RoomPlaneData = this.var_128[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
