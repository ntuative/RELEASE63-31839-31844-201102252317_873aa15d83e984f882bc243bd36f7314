package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_1564:Boolean = true;
      ...
      {
         if(this.var_2162 == param1 && this.var_2161 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            ...
            {
               this.var_1562 = _loc2_;
               this.var_2162 = param1;
               this.var_2161 = _direction;
               return this.var_1562;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_466 + 2;
         var _loc4_:int = this.var_549 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_548[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_548[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_466 == 0 || this.var_549 == 0)
         {
            ...
            this.var_466 = _loc2_.getNumber(RoomObjectVariableEnum.const_298);
            this.var_549 = _loc2_.getNumber(RoomObjectVariableEnum.const_363);
         }
         this.var_388 = [];
         this.var_548 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_466 * 2 + this.var_549 * 2)
         {
            this.var_388.push(false);
            this.var_548.push(ShoreMaskCreatorUtility.const_79);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_466 + 2;
         var _loc2_:int = this.var_549 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_68,getSize(param3),this.var_388,this.var_548,assetCollection);
      }
