package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1663:Number = Math.sqrt(0.5);
      ...
      protected var var_2740:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1225:String = null;
         ...
         if(_loc5_ != null && _loc4_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param2 != this.var_1584)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,param2,this.var_2740);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_441 != _loc3_.getUpdateID() || param1 != var_183 || param2 != this.var_2741)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2740 = _loc3_.getNumber(RoomObjectVariableEnum.const_222);
            ...
            this.var_1225 = _loc3_.getString(RoomObjectVariableEnum.const_387);
            if(this.var_1225 == null || this.var_1225.indexOf("http") != 0)
            {
               this.var_1225 = null;
            }
      ...
      {
         if(this.var_2201 != param2 || this.var_2203 != param1)
         {
            this.var_848 = [];
            this.var_847 = [];
            this.var_689 = [];
            ...
            this.var_2202 = this.getSize(param1);
            this.var_593 = this._data.getLayerCount(param1) + this.getAdditionalSpriteCount();
            this.var_1584 = this.var_593 - this.getAdditionalSpriteCount();
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_432.length)
         {
            return "";
         }
         var _loc3_:String = this.var_848[param2];
         var _loc4_:Boolean = this.var_847[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2202;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1584)
            {
               _loc6_ = FurnitureVisualizationData.const_432[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_848[param2] = _loc3_;
            this.var_847[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_693[param3] != null && !this.var_1583)
         {
      ...
      {
         if(this.var_688[param3] != null)
         {
            return this.var_688[param3];
         }
         if(this._data == null)
         {
