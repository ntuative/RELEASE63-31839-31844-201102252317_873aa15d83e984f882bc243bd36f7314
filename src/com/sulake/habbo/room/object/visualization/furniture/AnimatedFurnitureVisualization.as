package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_274:AnimatedFurnitureVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_274 = param1 as AnimatedFurnitureVisualizationData;
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this.var_274.isImmediateChange(this.var_808,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this.var_274.hasAnimation(this.var_808,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_104 != null)
         {
            this.var_104.setLayerCount(this.var_593);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         {
            this.var_808 = param1;
            this.var_593 = this.var_274.getLayerCount(param1);
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         if(_loc3_ == 0)
         {
            _loc3_ = this.var_274.getStartFrame(param2,_loc4_,_direction);
         }
         _loc3_ += 1;
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(!_loc8_)
            {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  ...
                  if(_loc11_ == AnimationFrame.const_994)
                  {
                     _loc10_ = this.var_274.getFrame(param2,_loc4_,_direction,_loc7_,_loc3_);
                  }
                  else
                  {
                     _loc10_ = this.var_274.getFrameFromSequence(param2,_loc4_,_direction,_loc7_,_loc11_,_loc10_.activeSequenceOffset + _loc10_.repeats,_loc3_);
                  }
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_496)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
      ...
      protected function method_16() : Boolean
      {
         return false;
      }
   }
