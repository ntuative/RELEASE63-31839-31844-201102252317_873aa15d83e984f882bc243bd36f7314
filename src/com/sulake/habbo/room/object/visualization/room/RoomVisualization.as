package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1402:int = 13421772;
      
      private static const const_920:int = 16777215;
      
      private static const const_921:int = 13421772;
      
      private static const const_922:int = 10066329;
      
      private static const const_919:int = 10066329;
      
      public static const const_1480:int = 16777215;
      
      public static const const_1641:int = 13421772;
      
      public static const const_1578:int = 10066329;
      ...
      private var var_473:RoomPlaneBitmapMaskParser = null;
      
      private var var_1623:String = null;
      
      private var _floorType:String = null;
      
      private var var_1624:String = null;
      
      private var var_2278:String = null;
      
      private var var_1067:uint = 16777215;
      
      private var var_2276:int = 255;
      
      private var var_2277:int = 255;
      
      private var var_2280:int = 255;
      ...
      private const const_1962:int = 250;
      
      private var var_1856:int = -1;
      
      private var var_1479:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_473 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1052);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1104);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_177)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_301)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1480;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1641;
               }
               else
               {
                  _loc13_.color = const_1578;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1453)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_110,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_301)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1962 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(_loc7_)
         {
            ...
            {
               _loc10_ = this.var_562[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_331[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_96)
               {
                  if(this.var_1617)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2280 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2277 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2276 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1856)
         {
            this.var_1856 = param1.updateId;
            this.var_703 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1479 || _loc3_.y != this.var_2274 || _loc3_.z != this.var_2279 || param1.scale != this.var_2275))
            {
               this.var_1479 = _loc3_.x;
               this.var_2274 = _loc3_.y;
               this.var_2279 = _loc3_.z;
               this.var_2275 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1023);
            if(_loc3_ != this.var_2278)
            {
            ...
            {
               this.var_1067 = _loc4_;
               this.var_2280 = this.var_1067 & 255;
               this.var_2277 = this.var_1067 >> 8 & 255;
               this.var_2276 = this.var_1067 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1130));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_164 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_785);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_779);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_695);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_684));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_879));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_707));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_331;
         if(this.var_331.length == 0)
         {
            _loc6_ = this.var_128;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_331.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_202)
                        {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_331.push(_loc12_);
                        this.var_562.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1616;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_473.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_473.maskCount)
         {
            _loc10_ = this.var_473.getMaskType(_loc8_);
            _loc11_ = this.var_473.getMaskLocation(_loc8_);
            _loc12_ = this.var_473.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_128.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_110 || _loc3_.type == RoomPlane.const_96)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_110 || _loc3_.type == RoomPlane.const_96 && _loc12_ == RoomPlaneBitmapMaskData.const_231)
                              {
