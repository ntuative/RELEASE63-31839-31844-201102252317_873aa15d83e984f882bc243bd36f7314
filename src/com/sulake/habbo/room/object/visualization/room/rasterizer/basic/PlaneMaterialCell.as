         ...
         if(this.var_558 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  _loc3_ = Math.min(this.var_1064,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1064,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1064,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_852[_loc6_ % this.var_852.length] as IGraphicAsset;
