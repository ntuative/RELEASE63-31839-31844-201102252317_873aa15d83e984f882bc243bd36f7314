package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1762:int = 16777216;
      ...
      private var var_2794:int = 69069;
      
      private var var_2793:int = 5;
      ...
      {
         var _loc1_:int = this.var_2794 * this.var_1835 + this.var_2793;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
