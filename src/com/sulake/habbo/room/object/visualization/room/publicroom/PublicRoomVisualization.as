package com.sulake.habbo.room.object.visualization.room.publicroom
{
   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      {
         createSprites(this.var_1228 + param1);
      }
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(this.data != null)
         {
            this.var_1228 = spriteCount;
            _loc2_ = object.getModel();
            _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_1172);
            ...
            {
               this.data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + this.var_1228));
               _loc4_++;
            }
            this.data.layoutRasterizer.initializeAds(this.var_1228,this);
         }
         this.var_2396 = true;
      }
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         var _loc6_:String = _loc5_.getString(RoomObjectVariableEnum.const_346);
         var _loc7_:* = !Boolean(_loc5_.getNumber(RoomObjectVariableEnum.const_577));
