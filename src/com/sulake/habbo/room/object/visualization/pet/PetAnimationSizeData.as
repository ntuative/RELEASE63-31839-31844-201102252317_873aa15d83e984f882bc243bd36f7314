package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_954 = param1.@defaultPosture;
         }
         else
         {
            this.var_954 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_1163.add(_loc6_,_loc7_);
         ...
         if(this.var_1163.getValue(this.var_954) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_1439.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_1163.getValue(param1) == null)
         {
            param1 = this.var_954;
         }
         return int(this.var_1163.getValue(param1));
      }
      
      public function getAnimationForGesture(param1:String) : int
      {
         if(this.var_1439.getValue(param1) == null)
         {
            return const_786;
         }
         return int(this.var_1439.getValue(param1));
      }
