package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_938:int = 1000;
      
      private static const const_1287:String = "pet_experience_bubble_png";
      
      private static const const_1285:int = 0;
      
      private static const const_1286:int = 1;
      ...
      private var var_274:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_274 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_274.commonAssets != null)
         {
            _loc3_ = this.var_274.commonAssets.getAssetByName(const_1287) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_371);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_258);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_338) > 0;
            this.var_1843 = _loc3_.getNumber(RoomObjectVariableEnum.const_279);
            this.var_1381 = _loc3_.getNumber(RoomObjectVariableEnum.const_854);
            this.var_2410 = _loc3_.getNumber(RoomObjectVariableEnum.const_662);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1716)
            {
               this.var_1716 = _loc6_;
               this.var_2427 = this.var_1716.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1381 > 0)
            {
               _loc2_ = param1 - this.var_1381;
               if(_loc2_ < const_938)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_938 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_257 = param1;
            _loc3_ = this.var_274.getAnimationForPosture(var_183,param1);
            this.setAnimationForIndex(const_1285,_loc3_);
         }
         if(param2 != this.var_1445)
         {
            this.var_1445 = param2;
            _loc3_ = this.var_274.getAnimationForGesture(var_183,param2);
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2427);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_597)
         {
            ...
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_432.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_432[param2];
               if(_loc4_ == 1)
               {
