package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_887 != null)
         {
            this.var_887.setValue(this.var_514);
         }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1668);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1665);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1666);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1667);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_622);
         }
         else
         {
