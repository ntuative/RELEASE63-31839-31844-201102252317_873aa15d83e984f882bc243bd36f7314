package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_160)
         {
            ...
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               this.method_6(_loc3_,_loc7_,_loc8_);
            }
         }
         _loc5_ = 0;
      ...
      private function method_6(param1:String, param2:String, param3:Number = 1.0) : void
      {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1178);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1154));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1018));
               this._widget.hide();
               break;
            case "clothes":
               ...
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1132));
               this._widget.hide();
               break;
            case "settings":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","IInventoryView") == "true";
               if(false && _loc4_)
               {
