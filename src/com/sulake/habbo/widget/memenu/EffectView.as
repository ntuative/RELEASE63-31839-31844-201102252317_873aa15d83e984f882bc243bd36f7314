package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_936 != null)
         {
            if(this.var_179.isActive)
            {
               ...
               this.var_936.width = _loc2_ * this.var_303;
            }
            else
            {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_934.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_934.text;
            if(this.var_179.isActive)
            {
               _loc2_ = this.var_179.secondsLeft;
               ...
               this.var_934.text = _loc1_;
            }
            else
            {
               this.var_934.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            if(this.var_179.isInUse)
            {
               this.method_6("effect_hilite","memenu_fx_pause");
            }
            else
            {
               this.method_6("effect_hilite","memenu_fx_play");
            }
            this.var_935 = this._window.findChildByName("effect_hilite");
            this.var_935.visible = false;
         }
         this.var_934 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_936 = this._window.findChildByName("loader_bar");
         if(this.var_936 != null)
         {
            this.var_303 = this.var_936.width;
            this.var_190.start();
            this.onUpdate();
         }
      ...
      private function method_6(param1:String, param2:String) : void
      {
