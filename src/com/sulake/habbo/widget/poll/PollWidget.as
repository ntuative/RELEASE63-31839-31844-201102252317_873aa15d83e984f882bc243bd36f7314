package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_278)
         {
            _loc1_ = this.var_278.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_278.getWithIndex(0) as PollSession;
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_137,this.showPollOffer);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_137,this.showPollOffer);
      ...
      private function showPollOffer(param1:Event) : void
      {
         ...
         var _loc3_:PollSession = this.var_278.getValue(_loc2_) as PollSession;
         var _loc4_:String = RoomWidgetPollUpdateEvent(param1).summary;
         if(!_loc3_)
         {
            _loc3_ = new PollSession(_loc2_,this);
            this.var_278.add(_loc2_,_loc3_);
      ...
      private function showPollContent(param1:Event) : void
      {
         ...
         {
            _loc3_ = _loc2_.id;
            _loc4_ = this.var_278.getValue(_loc3_) as PollSession;
            if(_loc4_)
            {
      ...
      {
         var _loc2_:PollSession = this.var_278.getValue(param1) as PollSession;
         if(_loc2_)
         {
            _loc2_.showThanks();
            _loc2_.dispose();
            this.var_278.remove(param1);
         }
      }
