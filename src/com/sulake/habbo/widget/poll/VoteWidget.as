package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1294:Array = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_367,this.update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_367,this.update);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(this.var_57.scrollableRegion.height - this.var_57.height,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         this.var_57 = this._window.findChildByName("choices") as IItemListWindow;
         if(this.var_57 == null)
         {
            return false;
         }
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         if(this._window == null || this.var_57 == null)
         {
            return;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_57.numListItems)
         {
            _loc2_ = this.var_57.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
            if(_loc4_ != this.var_1524)
            {
               _loc2_.blend = 0.5;
            }
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2092;
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_57.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_57.numListItems)
         {
            _loc4_ = this.var_57.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
