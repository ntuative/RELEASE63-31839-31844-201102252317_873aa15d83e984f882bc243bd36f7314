package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1256:Number = 100;
      
      private static const const_1257:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_429,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_438,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_374,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_429,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_438,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_374,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_429:
               this.hideInterface();
               this.var_327 = event.objectId;
               this.var_646 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_438:
               if(!this.var_1213)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_374:
               if(event.objectId != this.var_327)
               {
                  return;
               }
               this.var_646 = event.image;
      ...
      private function showInterface() : void
      {
         ...
         this._window.x = const_1256;
         this._window.y = const_1257;
      ...
      {
         var _loc2_:* = null;
         if(this.var_646 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_646.width) / 2,(_loc1_.height - this.var_646.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_646,this.var_646.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1213 || this.var_327 == -1)
         {
            return;
         }
         ...
         {
            this.var_1213 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_661,this.var_327,name);
