package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_1819:XML;
      
      private var var_610:BitmapData;
      
      private var var_1159:BitmapData;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_510.numGridItems)
         {
            return;
         }
         this.select(this.var_510.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_510 == null)
         {
            return;
         }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_336.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1819) as IWindowContainer;
            ...
            _loc3_.width = this.var_610.width;
            _loc3_.height = this.var_610.height;
            this.var_510.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_610.width,this.var_610.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_610,this.var_610.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1159.width,this.var_1159.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_948.width,this.var_948.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_948,this.var_948.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_510.getGridItemIndex(param1.target as IWindow);
