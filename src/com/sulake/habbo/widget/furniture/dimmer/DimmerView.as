package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1467:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_642:DimmerViewColorGrid;
      
      private var var_436:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_61,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1256,const_1257,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_642 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_436 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1466 = _loc2_.light;
         if(this.var_436 != null)
         {
            this.var_436.setValue(this.var_1466);
         }
         this.var_506 = this.colors.indexOf(_loc2_.color);
         if(this.var_642 != null)
         {
            this.var_642.setSelectedColorIndex(this.var_506);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1467 = XML(_loc1_.content);
         return this.var_1467;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_436 != null)
         {
            this.var_436.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_642 != null)
         {
            this.var_642.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
