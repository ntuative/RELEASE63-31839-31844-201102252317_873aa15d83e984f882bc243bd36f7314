package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_909:String = "Boy";
      
      private static const const_908:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1094,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_368,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1094,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_368,this.onUpdate);
      }
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_391:
               ...
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_368:
               this.hideEditorInterface();
         }
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2136 = param1.objectCategory;
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_672 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_145,true);
         this.var_672 = _loc4_;
         this.var_672.offset(100,100);
         var _loc6_:IWindow = this.var_672.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_359,param1,this.var_327,this.var_2136,this._roomId,this._roomCategory,_loc5_);
