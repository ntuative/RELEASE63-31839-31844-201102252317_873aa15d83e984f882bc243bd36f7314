package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_265:int = 0;
      
      public static const const_83:int = 39;
      
      private static const const_915:int = 150;
      
      private static const const_916:int = 250;
      ...
      private var var_2223:BitmapData;
      
      private var var_2225:BitmapData;
      
      private var var_2222:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_40 = param3;
         this.var_2224 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1601 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2220 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1602 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1600 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2223 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2225 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_72 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_273,HabboWindowStyle.const_31,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_83),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_72);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_61,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_40.height - const_83,param3.width,const_83),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_893,HabboWindowStyle.const_41,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_83),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_531:
               this.var_72.blend += param1 / const_916;
               this._window.blend += param1 / const_916;
               if(this._window.blend >= 1)
               {
                  this.state = const_340;
               }
               break;
            case const_959:
               this.var_72.blend -= param1 / const_915;
               this._window.blend -= param1 / const_915;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_40.width - this.var_2222;
         }
         if(this.var_72 != null)
         {
            this.var_72.rectangle = this.var_40.rectangle;
            this.var_72.height -= const_83;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2221 == this._window.width)
         {
            return;
         }
         this.var_2221 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2220;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1602;
            _loc2_.disposesBitmap = false;
            this.var_2222 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2224,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1601,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1601,_loc9_);
         ...
         this.var_72.bitmap = this.var_2225;
