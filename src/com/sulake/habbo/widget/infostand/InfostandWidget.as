package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1681:String = "infostand_furni_view";
      
      private const const_1678:String = "infostand_pet_view";
      
      private const const_1679:String = "infostand_bot_view";
      
      private var var_1034:InfoStandFurniView;
      ...
      private var var_1285:InfostandUserData;
      
      private var var_559:InfostandFurniData;
      ...
      private const const_1957:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1034 = new InfoStandFurniView(this,this.const_1681,this._catalog);
         this.var_121 = new InfoStandUserView(this,this.const_1680);
         this.var_323 = new InfoStandPetView(this,this.const_1678,this._catalog);
         this.var_386 = new InfoStandBotView(this,this.const_1679);
         this.var_1285 = new InfostandUserData();
         this.var_559 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_141 = new Timer(this.const_1957);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_833,this.onUserGivableBadges);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_833,this.onUserGivableBadges);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_382,this.var_323.getCurrentPetId()));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_121.setTags(param1.tags,this.var_2129);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_386.image = param1.image;
         }
         else
         {
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_386.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
