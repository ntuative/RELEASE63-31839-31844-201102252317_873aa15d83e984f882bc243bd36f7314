package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1969:int = 5;
      ...
      private var var_1090:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1091 = 0;
         this.var_1090 = param2.rectangle.clone();
         this.var_1090.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1090.width)
         {
            return false;
         }
         if(this.var_1091 + param1.height > this.var_1090.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1090.width)
         {
            this._offsetX = 0;
            this.var_1091 += param1.height + this.const_1969;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1091);
         this._offsetX += param1.width + this.const_1970;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1363 != null && this.var_1363.indexOf(param1) != -1)
         {
