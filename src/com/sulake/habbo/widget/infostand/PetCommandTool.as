package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_392:IFrameWindow;
      ...
      private const const_1960:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_329 = new Timer(this.const_1960);
         this.var_329.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1059.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_470);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1059.getValue(this.var_470) as CommandConfiguration;
      ...
      {
         this.var_1059.remove(param1);
         this.var_1059.add(param1,param2);
         if(param1 != this.var_470)
         {
            return;
         }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_726,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_39.setParamFlag(WindowParam.const_95,true);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_392 == null)
         {
            ...
            this.var_392 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_392 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_392.x = 200;
            this.var_392.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_382,this.var_470));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_525,this.var_470,this.var_1603 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_525,this.var_470,this.var_1603 + " " + _loc5_);
