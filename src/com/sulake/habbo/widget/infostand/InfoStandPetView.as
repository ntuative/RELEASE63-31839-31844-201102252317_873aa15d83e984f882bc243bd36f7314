package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_200:IBorderWindow;
      ...
      private const const_1987:int = 152;
      
      private const const_1981:int = 16;
      
      private const const_1353:int = 4;
      
      private const const_1988:uint = 14342874;
      
      private const const_1992:uint = 3815994;
      
      private const const_1986:uint = 2085362;
      
      private const const_1983:uint = 39616;
      
      private const const_1993:uint = 10513106;
      
      private const const_1990:uint = 8734654;
      
      private const const_1984:uint = 9094430;
      
      private const const_1989:uint = 6200576;
      
      private const const_1985:String = "happiness";
      
      private const const_1982:String = "experience";
      
      private const const_1991:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_200 == null || this.var_66 == null)
         {
            return;
         }
         ...
         this.var_200.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_200.width,this.var_66.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_200.width < this.var_66.width)
         {
            this.var_200.x = this._window.width - this.var_200.width;
            this.var_66.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1985,param1.nutrition,param1.nutritionMax,this.const_1983,this.const_1986);
         this.updateStateElement(this.const_1982,param1.experience,param1.experienceMax,this.const_1990,this.const_1993);
         this.updateStateElement(this.const_1991,param1.energy,param1.energyMax,this.const_1989,this.const_1984);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1987,this.const_1981,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1988);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1992);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1353,_loc7_.width - 2,_loc7_.height - 2 - this.const_1353);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1353);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_470) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_200 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_200 != null)
         {
            this.var_53 = this.var_200.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_200.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_200.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_200.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_200.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_201 && this.var_201.getPetId() == this.var_470)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1409,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_435,this._widget.petData.ownerId);
