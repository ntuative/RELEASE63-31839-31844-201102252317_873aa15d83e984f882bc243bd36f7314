   ...
   public class DoorbellView
   {
      ...
      public function update() : void
      {
         ...
         if(this.var_57 != null)
         {
            ...
            {
               this.var_57.addListItem(this.createListItem(this.var_328.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      public function createMainWindow() : void
      {
         ...
         this.var_57 = this._frame.findChildByName("user_list") as IItemListWindow;
         this._frame.visible = false;
