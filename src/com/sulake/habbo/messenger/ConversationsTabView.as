package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         this.var_888 = IWindowContainer(param2.findChildByName("conversationstab"));
      ...
      {
         return Math.floor(this.var_888.width / this.var_1082);
      }
      ...
      {
         var _loc3_:IWindowContainer = this.var_888.getChildAt(param1) as IWindowContainer;
         if(_loc3_ == null)
         {
            if(param2 == null)
            {
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_888.width % this.var_1082;
