package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      {
         var _loc2_:Conversation = this.var_561.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            this.var_561.setSelected(_loc2_);
      ...
      {
         this.var_561.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_561.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         this.var_566.playSound(HabboSoundTypesEnum.const_1050);
      }
      ...
      {
         this.var_561 = new Conversations(new ConversationsDeps(this));
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_687,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      {
         this.var_561.addMessageAndUpdateView(param1);
         if(!this.var_240.isMessengerOpen())
         {
            this.var_566.playSound(HabboSoundTypesEnum.const_1207);
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1106,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_561.addMessageAndUpdateView(_loc3_);
      }
