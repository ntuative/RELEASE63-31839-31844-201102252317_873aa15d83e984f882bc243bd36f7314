package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_150.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_134,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1688,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_150.habboConfiguration.getKey("use.sso","IInventoryView") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1688,"/");
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_127.removeEventListener(SSOTicket.const_343,this.onParsedTicketSuccess);
            this.var_127.removeEventListener(SSOTicket.const_321,this.onParsedTicketFailure);
            this.var_127 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_127 = new SSOTicket(this.var_150.assets,_loc3_,_loc2_,param1);
         this.var_127.addEventListener(SSOTicket.const_343,this.onParsedTicketSuccess);
         this.var_127.addEventListener(SSOTicket.const_321,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_150.shockwaveClientUrl = this.var_127.shockwaveClientUrl;
         this.var_150.ssoTicket = this.var_127.ticket;
         this.var_127.removeEventListener(SSOTicket.const_343,this.onParsedTicketSuccess);
         this.var_127.removeEventListener(SSOTicket.const_321,this.onParsedTicketFailure);
         this.var_127 = null;
         dispatchEvent(new Event(const_427));
