package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_484:IKeyExchange;
      
      private var var_886:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2356:PseudoRandom;
      ...
      private const const_1688:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_571 = param1;
            this.var_51.initConnection(HabboConnectionType.const_236);
         }
      }
      ...
      {
         if(this.var_51 && this.var_145 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:String = this.var_145.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_145.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_208.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_145.getKey("use.sso.ticket") == "1";
         this.var_571 = this.var_145.getKey("sso.ticket",null);
         this.var_1664 = this.var_145.getKey("flash.client.url","");
         this.var_2354 = this.var_145.getKey("external.variables.txt","");
         if(this.var_208 == null)
         {
            this.var_208 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_51.mode = HabboConnectionType.const_1204;
            }
         }
         this.var_51.initConnection(HabboConnectionType.const_236);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_641);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2356 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_51.mode)
         {
            case HabboConnectionType.const_84:
               ...
               this.var_1349 = _loc4_;
               this.var_208.loadBannerImage(_loc7_ + "?token=" + this.var_1349,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1204:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1447:
               this.var_886 = this.generateRandomHexString(30);
               this.var_484 = new DiffieHellman(new BigInteger(this.var_145.getKey("connection.development.prime"),16),new BigInteger(this.var_145.getKey("connection.development.generator"),16));
               this.var_484.init(this.var_886);
               _loc8_ = this.var_484.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_484.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_484.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2356);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1664,this.var_2354));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1688,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2355)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1349);
         ...
         this.var_484 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_484.init(_loc14_);
            _loc15_ = this.var_484.getPublicKey(10);
