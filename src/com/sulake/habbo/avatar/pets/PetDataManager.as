package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private var var_154:AvatarRenderManager;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_427.getValue(_loc4_) == null)
               {
                  this.var_427.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_512.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_427.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc4_:PetData = this.var_427.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_427.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_427.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         for each(_loc6_ in _loc4_)
         {
            ...
            {
               _loc7_ = false;
               if(this.var_615.getValue(_loc6_) == null)
               {
                  ...
                  this.var_615.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_512.indexOf(param3) == -1)
                  {
                     this.var_512.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_615.getKeys())
         {
            _loc5_ = this.var_615.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
