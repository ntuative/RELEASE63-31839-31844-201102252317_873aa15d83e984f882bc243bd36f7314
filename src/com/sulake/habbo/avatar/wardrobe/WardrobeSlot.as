package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_589 && this.var_1399)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_87,this.var_918,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_34,parseInt(FigureData.const_851));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1399 && this.var_589 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_589 = this._controller.figureData.getFigureString();
               this.var_918 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1751,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_589)
               {
                  this._controller.loadAvatarInEditor(this.var_589,this.var_918,this._controller.clubMemberLevel);
               }
         }
      }
