package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_563:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_563 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_563.numGridItems > 0)
         {
            this.var_563.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_65 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_65.hotLooks)
         {
            ...
            this.var_563.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_563.getGridItemIndex(param2.parent);
