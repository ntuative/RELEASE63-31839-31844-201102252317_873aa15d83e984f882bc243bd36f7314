package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1350:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      ...
      private var var_1196:AvatarEditorHandler;
      ...
      private var var_972:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_184)
         {
            ...
            this.var_641["null"] = new FigureData(this);
            this.var_641["null"] = new FigureData(this);
            _loc2_ = this.var_641["null"];
            _loc3_ = this.var_641["null"];
            _loc2_.loadAvatarData(const_1350,FigureData.const_73);
            _loc3_.loadAvatarData(const_1352,FigureData.FEMALE);
            this.var_95 = new Map();
            this.var_521 = new Map();
            this.var_95.add(AvatarEditorFigureCategory.const_822,new BodyModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_247,new TorsoModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_870,new LegsModel(this));
            ...
            this.var_521.add(AvatarEditorSideCategory.const_104,new WardrobeModel(this));
            this.var_521.add(AvatarEditorSideCategory.const_439,new ClubPromoModel(this));
            this.var_184 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_641[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_972.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_972.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_822);
         }
      ...
      {
         this.var_972 = this.var_520.getFigureData(AvatarType.const_116);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1196 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_641[this.var_918];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1890;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1197 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1351)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1482.clone() as IWindowContainer,param1,_loc13_);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1197 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1197 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_521.getValue(AvatarEditorSideCategory.const_104);
      }
