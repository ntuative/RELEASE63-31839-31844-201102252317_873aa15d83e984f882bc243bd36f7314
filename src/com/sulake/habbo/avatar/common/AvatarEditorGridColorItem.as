package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_835:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_907.width,this.var_907.height,true,0);
            _loc5_ = this.var_907.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_835.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_834.width,this.var_834.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_834,this.var_834.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_835)
            {
               switch(this.var_835.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_42:
                     _loc4_.style = HabboIconType.const_841;
                     _loc4_.visible = true;
               }
            }
            else
