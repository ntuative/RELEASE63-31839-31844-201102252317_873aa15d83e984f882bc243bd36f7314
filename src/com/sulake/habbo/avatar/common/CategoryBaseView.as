package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      protected function method_6(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_1956);
      ...
      protected function method_5() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_37[this.var_138];
         if(_loc2_ == null)
         {
            return;
         }
