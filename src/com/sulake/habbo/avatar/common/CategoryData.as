package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2008:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_258)
         {
            for each(_loc2_ in this.var_258 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_964 >= 0 && this._parts.length > this.var_964)
         {
            _loc2_ = this._parts[this.var_964];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = this.var_258[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_258.length <= param1)
         {
            return null;
         }
         return this.var_258[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_964] as AvatarEditorGridPartItem;
      }
