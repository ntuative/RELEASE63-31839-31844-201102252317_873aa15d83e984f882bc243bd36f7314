package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_589:AvatarFigureContainer;
      ...
      private var var_2632:String = null;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_673)
         {
            ...
            if(this.var_771)
            {
               for each(_loc2_ in this.var_771)
               {
                  _loc2_.dispose();
               }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_259.length == 1 && this.var_88 == this.var_1992)
         {
            return this.var_88 + this.var_516 + this.var_625 % 4;
         }
      ...
      {
         if(param3 != this.var_2631 || param2 != this.var_2632 || param1 != this.var_2630)
         {
            this.var_2631 = param3;
            this.var_2632 = param2;
            this.var_2630 = param1;
            this.var_1853 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1233 || this.var_44 == null || (this.var_44.width != _loc5_.width || this.var_44.height != _loc5_.height))
         {
            if(this.var_44 != null && !this.var_1233)
            {
               this.var_44.dispose();
            }
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_315.push(new ActiveActionData(param1,param2,this.var_625));
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_516 = "";
         this.var_259 = this._structure.sortActions(this.var_315);
         if(this.var_259 == null)
         {
         ...
         {
            this.var_790 = this._structure.getCanvasOffsets(this.var_259,this._scale,this.var_88);
            for each(_loc4_ in this.var_259)
            {
               this.var_516 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_315)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1451 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1451 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_259)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_841 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_313 || _loc1_.actionType == AvatarAction.const_261 || _loc1_.actionType == AvatarAction.const_369)
               {
                  this.var_841 = true;
               }
            }
