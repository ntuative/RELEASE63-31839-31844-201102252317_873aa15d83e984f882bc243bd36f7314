package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_422:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_903:AvatarActionManager;
      
      private var var_345:FigureData;
      
      private var var_410:PartSetsData;
      
      private var var_274:AnimationData;
      
      private var var_732:AnimationManager;
      
      private var var_842:ActionDefinition;
      
      private var var_492:String;
      
      private var var_1386:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_410 = new PartSetsData();
         this.var_274 = new AnimationData();
         this.var_732 = new AnimationManager();
         this.var_492 = param2;
      ...
      {
         this.var_1386.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_492);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_492);
            return;
         }
         this.var_903 = new AvatarActionManager(param1,this.var_492,param2);
         this.var_842 = this.var_903.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_492);
            return false;
         }
         if(this.var_410.parse(param1))
         {
            if(this.var_492 == AvatarType.const_116)
            {
               this.var_410.getPartDefinition("ri").appendToFigure = true;
               this.var_410.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_492);
            return false;
         }
         return this.var_274.parse(param1);
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_492);
            return false;
         }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_732.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_732.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_732.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_903.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_903.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_903.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_583[param1] = new Dictionary();
         }
         if(this.var_583[param1][param2])
         {
            return this.var_583[param1][param2];
         }
         this.var_583[param1][param2] = this.var_345.getMandatorySetTypeIds(param1,param2);
         return this.var_583[param1][param2];
      }
      ...
      {
         return this.var_903.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_732.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_410.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_410.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1386[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_410.getActiveParts(param3.definition);
         var _loc10_:Array = new Array();
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_274.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc23_ = param3.definition.state + "." + param3.actionParameter;
            _loc9_ = this.var_732.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_842;
                           }
                           _loc12_ = this.var_410.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_410.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1386.getOffset(param1,param2,param3,param4,param5,param6);
      }
