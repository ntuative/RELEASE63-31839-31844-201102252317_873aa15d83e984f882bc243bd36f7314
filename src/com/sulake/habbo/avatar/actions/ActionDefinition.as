package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2731 = parseInt(param1.@precedence);
         this.var_2730 = String(param1.@activepartset);
         this.var_2725 = String(param1.@assetpartdefinition);
         this.var_2726 = String(param1.@lay);
         this.var_717 = String(param1.@geometrytype);
         this.var_2310 = Boolean(parseInt(param1.@main));
         this.var_2729 = Boolean(parseInt(param1.@name_6));
         this.var_2727 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2728 = _loc6_;
            }
            else
            {
               this.var_1934[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_122[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1934[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2728;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_122[param1];
         if(_loc2_ != null)
         {
