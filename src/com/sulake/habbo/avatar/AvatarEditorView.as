package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1956:int = 6710886;
      ...
      private var var_499:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_500:IFrameWindow;
      
      private var var_413:Timer;
      
      private var var_2480:Number = 0;
      
      private var var_2481:Boolean = true;
      
      private var var_1754:String;
      
      private var var_2482:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1124 = [];
         this.var_1401 = [AvatarEditorFigureCategory.const_822,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_247,AvatarEditorFigureCategory.const_870,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_104];
         super();
         ...
         if(var_1482 == null)
         {
            ...
            var_1482 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_413 = new Timer(1000);
         this.var_413.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1401;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1401);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2481 = this.canChangeOutfit();
            this.var_413.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_499 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_499.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_499.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1124.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_499.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_499.numSelectables)
               {
                  this.var_499.getSelectableAt(_loc6_).x = this.var_499.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1401;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40) && (this.var_1754 == AvatarEditorSideCategory.const_104 || this.var_2482))
         {
         ...
         this.setViewToCategory(this.var_337);
      }
      ...
      {
         if(this.var_1754 == AvatarEditorSideCategory.const_104)
         {
            this.var_2482 = false;
            this.setSideContent(AvatarEditorSideCategory.const_645);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_104);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_645:
               break;
            case AvatarEditorSideCategory.const_439:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_439);
               break;
            case AvatarEditorSideCategory.const_104:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_104);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_337 = param1;
         this.var_499.setSelected(this.var_499.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_500)
         {
            ...
            this.var_500 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_500.procedure = this.stripClubDialogEventProc;
            this.var_500.center();
         }
         else
         {
            this.var_500.visible = true;
            this.var_500.center();
         }
      }
