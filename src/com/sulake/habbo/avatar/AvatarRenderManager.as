package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_293:PetDataManager;
      ...
      private var var_1678:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_567 = RenderMode.const_1431;
         ...
         this.var_99.add(AvatarType.const_116,_loc4_);
         ...
         this.var_99.add(AvatarType.const_72,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_293 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         ...
         this.var_293.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_99 != null)
         {
            for each(_loc1_ in this.var_99.getValues())
            {
               _loc1_.dispose();
            }
            this.var_99.dispose();
         ...
         if(this.var_210)
         {
            this.var_210.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_293.init();
         this.var_719.init();
         _loc2_ = this.var_99.getValue(AvatarType.const_116) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_99.getValue(AvatarType.const_72) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_99.getValue(AvatarType.const_116) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_210 == null)
               {
                  ...
                  this.var_210 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_210.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_874)
         {
            if(this.var_2373 && this.var_2372 && this.var_2371)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_210.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_210.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_99.getValue(AvatarType.const_116) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_210.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1678)
         {
            this.var_1678 = new AvatarFigureContainer(this.const_1968);
         }
         this.var_210.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1678,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_292 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_292.getKeys())
         {
            _loc4_ = this.var_292.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_293.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1385)
         {
            _loc6_ = !this.var_293.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_293.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_99.getValue(AvatarType.const_72) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_292.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_293.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_99.getValue(AvatarType.const_72);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_292.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_292.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_99.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_99.getValue(AvatarType.const_116) as AvatarStructure;
      ...
      {
         return this.var_293 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_72:
               _loc3_ = this.var_99.getValue(AvatarType.const_72) as AvatarStructure;
               break;
            default:
