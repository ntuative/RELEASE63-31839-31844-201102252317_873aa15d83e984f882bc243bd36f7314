package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1730:Number = 1.0;
      
      private var var_1732:Number = 1.0;
      
      private var var_1731:Number = 1.0;
      ...
      {
         super();
         this.var_1494 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2002 = parseInt(_loc2_,16);
         this.var_2001 = parseInt(_loc3_,16);
         ...
         this.var_1741 = new ColorTransform(this.var_1730,this.var_1732,this.var_1731,this._alphaMultiplier);
         this.var_1001 = this.generatePaletteMapForGrayscale(this.var_2001,this.var_2002);
      }
      ...
      {
         return this.var_1001.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1001.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1001.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1001.getValue("alphas") as Array;
      }
