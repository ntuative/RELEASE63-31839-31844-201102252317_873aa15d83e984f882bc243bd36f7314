package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_943:int = 3;
      
      private var var_421:AssetLoaderStruct;
      
      private var var_942:Timer;
      ...
      private const const_1977:int = 100;
      
      private const const_1535:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_942 = new Timer(this.const_1977,1);
         this.var_942.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_421)
         {
            ...
            this.var_421.addEventListener(AssetLoaderEvent.const_46,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_421)
         {
            ...
            this.var_421.removeEventListener(AssetLoaderEvent.const_46,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_943);
            if(this.var_1430.indexOf("?") > 0)
            {
               _loc2_ = this.var_1430 + "&retry=" + this.var_943;
            }
            else
            {
               _loc2_ = this.var_1430 + "?retry=" + this.var_943;
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1813 = true;
         for each(_loc2_ in this.var_1155)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2585,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1813)
         {
            this.var_1155.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_512[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_512[_loc3_] = _loc6_;
            }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         for(_loc3_ in this.var_944)
         {
            ...
            if(_loc7_)
            {
               ...
               delete this.var_512[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_944[_loc3_];
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_755.length > 0 && this.var_756.length < this.const_1535)
         {
            _loc1_ = this.var_755[0];
            _loc1_.startDownloading();
            this.var_756.push(this.var_755.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_755.indexOf(param1) == -1 && this.var_756.indexOf(param1) == -1)
         {
