package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1108:BitmapData = null;
      
      private var var_1109:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2456 = this._config.getKey("interstitial.enabled","IInventoryView") == "true";
         this.var_2455 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2453 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1735 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_213 != null && this.var_213.running)
         {
            this.var_213.reset();
            return false;
         }
         if(this.var_1110 == 0)
         {
            this.var_1110 = getTimer();
            return false;
         }
         if(this.var_1735 > 0 && this.var_1734 >= this.var_1735)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1110;
         if(_loc1_ > this.var_2455)
         {
            ++this.var_1734;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1387 = _loc2_.imageUrl;
         this.var_2454 = _loc2_.clickUrl;
         this.var_1110 = getTimer();
         if(this.var_1387 != "")
         {
            _loc3_ = this.var_1387;
            ...
            {
               this.var_213 = new Timer(this.var_2453,1);
               this.var_213.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_213.running)
            {
               this.var_213.reset();
            }
            this.var_213.start();
            _loc4_ = new URLRequest(this.var_1387);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_507,0,0,param1.bitmapData,this.var_2454));
            this.var_1110 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_506));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1388 = _loc2_.imageUrl;
         this.var_1736 = _loc2_.clickUrl;
         if(this.var_1388 != "" && this.var_1736 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1388);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_539,0,0,_loc4_,this.var_1736,this.var_1108,this.var_1109));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1108 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1109 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
