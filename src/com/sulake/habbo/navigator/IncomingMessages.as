package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.securityLevel >= SecurityLevelEnum.const_1047)
            {
               this._navigator.data.eventMod = true;
            }
            if(_loc2_.securityLevel >= SecurityLevelEnum.const_1571)
            {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_195 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onUserFlatCats(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:RoomsTabPageDecorator = RoomsTabPageDecorator(this._navigator.tabs.getTab(Tabs.const_250).tabPageDecorator);
