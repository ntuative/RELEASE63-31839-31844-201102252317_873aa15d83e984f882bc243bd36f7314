package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_341);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_681);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_341,"" + _loc3_);
         }
      }
   }
}
