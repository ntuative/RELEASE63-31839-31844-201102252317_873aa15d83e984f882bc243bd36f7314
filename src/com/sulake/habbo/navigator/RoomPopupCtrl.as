package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2214 = new RoomThumbnailRenderer(param1);
         this.var_1184 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_170,this.var_109);
         if(this.var_109.ownerName != "" && this.var_109.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_170,!!this.var_109.event ? this.getEventCtg(this.var_109.categoryId) : this.getRoomCtg(this.var_109.categoryId));
         this.refreshRoomDesc(this.var_170,this.var_109);
         this.refreshExtraCont();
         this.refreshInfo(this.var_170,"trading_allowed",this.var_109.allowTrading);
         this.refreshInfo(this.var_170,"doormode_doorbell",this.var_109.doorMode == 1);
         this.refreshInfo(this.var_170,"doormode_password",this.var_109.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_170,this.var_109.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1184.refreshTags(_loc1_,this.var_109.tags);
         ...
         this.var_2214.refreshThumbnail(_loc1_,this.var_109.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_237,Tabs.const_246,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
