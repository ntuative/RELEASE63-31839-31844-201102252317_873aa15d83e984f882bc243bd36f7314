package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailEditorModel
   {
      ...
      private var var_191:RoomThumbnailObjectData;
      ...
      private function removeSelected() : void
      {
         ...
         var _loc2_:int = Util.remove(_loc1_,this.var_191);
         this.var_191 = null;
         if(_loc1_.length > 0)
         {
            this.var_191 = _loc1_[Math.min(_loc2_,_loc1_.length - 1)];
         }
      }
      ...
      {
         this.var_191 = this.findByPos(param1);
         if(this.var_191 == null)
         {
      ...
      {
         if(this.var_567 == const_36)
         {
            this._data.bgImgId = param1;
         }
         else if(this.var_567 == const_59)
         {
            this._data.frontImgId = param1;
         }
         if(this.var_567 == const_33)
         {
            if(this.var_191 == null)
            {
               return;
            }
            this.var_191.imgId = param1;
         }
      }
      ...
      public function getImgId() : int
      {
         ...
         if(this.var_567 == const_59)
         {
            return this._data.frontImgId;
         }
         return this.var_191 == null ? -1 : int(this.var_191.imgId);
      }
      ...
      {
         this._data = param1;
         this.var_567 = const_36;
         if(this._data.objects.length > 0)
         {
            this.var_191 = this._data.objects[0];
         }
         else
         {
            this.var_191 = null;
