package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_520:int = 10;
      
      private static const const_962:int = 32;
      
      private static const const_1347:int = 8;
      
      private static const const_1349:int = -16;
      ...
      private var var_967:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_967 = new ThumbnailImageConfigurations(this._navigator);
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2660 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_962 / 2);
         return new Point(param1 * const_962 + _loc3_,param2 * const_1347);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_273,HabboWindowStyle.const_41,0 | (!!param3 ? HabboWindowParam.const_37 : HabboWindowParam.const_41),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_967.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_967.getImage(ThumbnailEditorModel.const_36,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_967.getImage(ThumbnailEditorModel.const_59,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_967.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1349,_loc4_.y + const_1348 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2660[param1]);
      }
   }
}
