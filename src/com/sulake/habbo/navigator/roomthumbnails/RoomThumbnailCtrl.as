package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1765:IButtonWindow;
      
      private var var_1766:IButtonWindow;
      
      private var var_2514:IWindowContainer;
      
      private var var_2515:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1764 = IButtonWindow(this.find("bg_tab"));
         this.var_1765 = IButtonWindow(this.find("top_tab"));
         this.var_1766 = IButtonWindow(this.find("obj_tab"));
         this.var_2514 = IWindowContainer(this.find("tile_grid"));
         this.var_2515 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1764,this.onBgTabButton);
         Util.setProcDirectly(this.var_1765,this.onTopTabButton);
         Util.setProcDirectly(this.var_1766,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1764,this.var_65.mode != ThumbnailEditorModel.const_36);
         this.setEnabled(this.var_1765,this.var_65.mode != ThumbnailEditorModel.const_59);
         this.setEnabled(this.var_1766,this.var_65.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2515;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2514;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_520)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_273,HabboWindowStyle.const_41,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
