package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_608:RoomInfoViewCtrl;
      
      private var var_1153:RoomCreateViewCtrl;
      ...
      private var var_2214:RoomThumbnailRenderer;
      
      private var var_819:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_608 = new RoomInfoViewCtrl(this);
         this.var_1153 = new RoomCreateViewCtrl(this);
         this.var_2214 = new RoomThumbnailRenderer(this);
         this.var_819 = new GuestRoomPasswordInput(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_273,HabboWindowStyle.const_41,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_608.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_181.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_305.startSearch(Tabs.const_237,Tabs.const_386,param1);
         this.var_305.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_305.startSearch(Tabs.const_307,Tabs.const_240);
         this.var_408.getTab(Tabs.const_307).tabPageDecorator.tabSelected();
      }
