package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_1030:String = "RS_CONNECTED";
      
      public static const const_1013:String = "RS_READY";
      
      public static const const_829:String = "RS_DISCONNECTED";
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1030);
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            ...
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1013);
         }
      }
      ...
      private function onFlatAccessDenied(param1:FlatAccessDeniedMessageEvent) : void
      {
         ...
         if(_loc5_ == null || _loc5_.length == 0)
         {
            if(listener)
            {
               listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_829);
            }
         }
         else if(listener && false)
         {
