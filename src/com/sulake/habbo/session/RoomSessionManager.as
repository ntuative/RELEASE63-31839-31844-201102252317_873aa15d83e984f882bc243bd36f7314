   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_203)
         {
            ...
            {
               _loc1_ = this.var_203.getKey(0) as String;
               _loc2_ = this.var_203.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1547)
         {
            this.gotoRoom(this.var_2130,this.var_2132,this.var_1548);
            this.var_1547 = false;
            this.var_1548 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_215,_loc7_));
         return true;
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1030:
                  break;
               case RoomSessionHandler.const_1013:
                  break;
               case RoomSessionHandler.const_829:
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_203.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_203.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_203.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_203.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_203.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
