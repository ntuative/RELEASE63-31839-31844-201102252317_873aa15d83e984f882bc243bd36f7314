package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1958:int = 2500;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1037 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1037.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_215 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1289));
         this.var_1290.add(this.var_1289,getTimer());
         ++this.var_1289;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1290.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1958)
            {
      ...
      {
         return this.var_1037 as IUserDataManager;
      }
