package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_919:Array = [];
      
      private static var var_1752:int = 200;
      ...
      {
         this.var_741 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
         ...
         this.var_57 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1614;
      }
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_57);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_919.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_741.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_919.length < var_1752)
         {
            ...
            param1.width = this.var_741.width;
            param1.height = this.var_741.height;
            var_919.push(param1);
         }
         else
         {
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_57.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_57.scrollableRegion.height > this.var_57.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_57.width += 17;
            }
         }
         else if(_loc4_)
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1400)
         {
