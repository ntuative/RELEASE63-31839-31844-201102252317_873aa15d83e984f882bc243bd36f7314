package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_964:int = 60;
      
      private static const const_966:int = 3600;
      
      private static const const_965:int = 86400;
      
      private static const const_963:int = 31536000;
      ...
      {
         if(param1 < 2 * const_964)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_966)
         {
            return Math.round(param1 / const_964) + " mins ago";
         }
         if(param1 < 2 * const_965)
         {
            return Math.round(param1 / const_966) + " hours ago";
         }
         if(param1 < 2 * const_963)
         {
            return Math.round(param1 / const_965) + " days ago";
         }
         return Math.round(param1 / const_963) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1203.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_33.getXmlWindow("user_info"));
            this.var_1203.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_33,WindowTracker.const_1160,this._data.userId),this._callerFrame,this.var_1202,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new RoomVisitsCtrl(this.var_33,this._data.userId),this._callerFrame,this.var_1202,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new SendMsgsCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1462),this._callerFrame,this.var_1202,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ModActionCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1462),this._callerFrame,this.var_1202,false,true);
      }
