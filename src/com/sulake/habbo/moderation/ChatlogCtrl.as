package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1680:int = 1000;
      
      private static var var_891:Array = [];
      
      private static var var_1679:int = 200;
      ...
      private var var_1671:IMessageComposer;
      ...
      {
         this.var_721 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_720 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         ...
         this.var_57 = IItemListWindow(this._frame.findChildByName("chatline_list"));
         this._frame.procedure = this.onWindow;
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_33.connection.send(this.var_1671);
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         this.addHeaderLineToList(_loc2_,this.var_57);
         var _loc4_:* = true;
         for each(_loc5_ in param1.chatlog)
         {
            this.populateChatline(this.var_57,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_720.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_892.length < var_1680)
         {
            ...
            param1.width = this.var_720.width;
            param1.height = this.var_720.height;
            var_892.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1681[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1359.getValue(param2.chatterName))
            {
               this.var_1359.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1359.getValue(_loc2_);
      ...
      private function refreshListDims() : void
      {
         ...
         var _loc2_:* = null;
         this.var_57.autoArrangeItems = false;
         var _loc3_:int = this.var_57.numListItems;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc1_ = IWindowContainer(this.var_57.getListItemAt(_loc4_));
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1357)
         {
