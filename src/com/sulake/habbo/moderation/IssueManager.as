package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_757:String = "issue_bundle_my";
      
      public static const const_981:String = "issue_bundle_picked";
      
      public static const const_1639:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_584 = new IssueBrowser(this,this.var_63.windowManager,this.var_63.assets);
         this.var_1107 = [];
         this.var_1106 = [];
         this.var_905 = new Map();
         this.var_2445 = parseInt(this.var_63.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1727 = new Timer(const_1639,0);
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1107 = this.var_1107.concat(_loc4_.getIssueIds());
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1106 = this.var_1106.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_584 == null || !this.var_584.isOpen())
         {
            this.var_63.soundManager.playSound(HabboSoundTypesEnum.const_1007);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_904.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_904.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1443)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_100)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_904.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2446++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_904.add(param1.issueId,_loc2_);
         ...
         if(this.var_1107.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_757);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1106.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      {
         var _loc2_:IssueHandler = this.var_905.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_905.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_904.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_100.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_905.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_905.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_905.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
