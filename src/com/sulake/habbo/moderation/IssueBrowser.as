package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2005:String = "my_issues";
      
      private const const_2006:String = "open_issues";
      
      private const const_2004:String = "picked_issues";
      
      private const const_2009:String = "closed_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_372.view.width = this.var_266.container.width;
         this.var_372.view.height = this.var_266.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2005:
               if(this.var_1916 == null)
               {
                  this.var_1916 = new MyIssuesView(this.issueManager,this,this.var_266.container);
               }
               return this.var_1916;
            case this.const_2006:
               if(this.var_1917 == null)
               {
                  this.var_1917 = new OpenIssuesView(this.issueManager,this,this.var_266.container);
               }
               return this.var_1917;
            case this.const_2004:
               if(this.var_1918 == null)
               {
                  this.var_1918 = new PickedIssuesView(this.issueManager,this,this.var_266.container);
               }
