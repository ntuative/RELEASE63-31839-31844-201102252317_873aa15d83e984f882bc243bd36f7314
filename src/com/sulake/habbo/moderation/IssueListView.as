package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1660 = this.var_584.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         {
            this.var_57.destroyListItems();
            return;
         }
         param1.sortOn("prioritySum",0 | 0);
         var _loc4_:int = this.var_57.numListItems;
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1660.clone() as IWindowContainer;
         ...
         else if(_loc4_ > _loc5_)
         {
            ...
            {
               _loc9_ = this.var_57.removeListItemAt(0);
               _loc9_.dispose();
               _loc2_++;
            }
         }
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1660 == null)
            {
               return;
            }
            _loc3_ = this.var_57.getListItemAt(_loc2_ - 1) as IWindowContainer;
            if(_loc3_ == null)
            {
               return;
            }
            _loc3_.width = this.var_57.width;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_584.assets.getAssetByName(_loc12_) as BitmapDataAsset;
