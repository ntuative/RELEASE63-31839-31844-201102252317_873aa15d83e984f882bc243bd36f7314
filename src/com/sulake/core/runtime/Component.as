package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1729:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1015:uint = 4;
       
      
      protected var var_701:uint = 0;
      ...
      private var var_503:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_503 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_503.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_503.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1229 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1229);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1437 & const_1015)
         {
            if(_loc3_ == 0)
            {
               if(this.var_503.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_701 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_503.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_503.getStructByIndex(_loc8_);
