package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1323:String = "asset-libraries";
      
      private static const const_1329:String = "library";
      
      private static const const_1324:String = "service-libraries";
      
      private static const const_1326:String = "library";
      
      private static const const_1325:String = "component-libraries";
      
      private static const const_1327:String = "library";
      
      private static const const_1322:String = "error_data";
      
      private static const const_1328:String = "error_cat";
      
      private static const const_1330:String = "error_desc";
       
      
      private var var_357:LibraryLoaderQueue;
      
      private var var_763:IEventDispatcher;
      
      private var var_511:uint;
      
      private var var_424:Function;
      
      private var var_253:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_425.push(new Array());
            this.var_614.push(0);
            _loc3_++;
         }
         this._lastUpdateTimeMs = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_447.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            ...
            case Core.const_819:
               ...
               break;
            case Core.const_1412:
               debug("Core; using profiler frame update handler");
               this.var_424 = this.profilerFrameUpdateHandler;
               this.var_253 = new Profiler(this);
               attachComponent(this.var_253,[new IIDProfiler()]);
               var_447.addChild(new ProfilerViewer(this.var_253));
               break;
            case Core.const_899:
      ...
      {
         return this.var_511 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_447.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_447 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_123)
            {
               _loc2_ = this.var_425[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         ...
         ErrorReportStorage.setParameter(const_1330,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_763 = loadingEventDelegate;
         if(this.var_357 == null)
         {
         ...
         try
         {
            node = config.child(const_1323)[0];
            if(node != null)
            {
               list = node.child(const_1329);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1620);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_763)
         {
            this.var_763.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_763)
         {
            ...
            this.var_763.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_763)
                  {
                     this.var_763.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_511 - this.var_357.length,this.var_511,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_425[param2] as Array;
         if((this.var_1437 & 0) == Core.const_899)
         {
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_425[_loc4_] as Array;
            if((this.var_1437 & 0) == Core.const_899)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_614[criticality] = 0;
            receivers = this.var_425[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_447.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_123)
         {
            ...
            {
               if(this.var_614[priority] < priority)
               {
                  ++this.var_614[priority];
                  skip = true;
               }
            }
            if(!skip)
            {
               this.var_614[priority] = 0;
               receivers = this.var_425[priority];
               index = 0;
               length = receivers.length;
               while(index != length)
               {
         ...
         while(priority < CoreComponentContext.const_123)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_253.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_253)
            {
               detachComponent(this.var_253);
               this.var_253.dispose();
               this.var_253 = null;
            }
            switch(this.var_1437 & 0)
            {
               case Core.const_1051:
                  this.var_424 = this.simpleFrameUpdateHandler;
                  break;
