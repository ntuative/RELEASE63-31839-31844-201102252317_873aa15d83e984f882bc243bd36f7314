package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_486:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_486 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_106 is BitmapDataAsset)
         {
            ...
            this.var_1256 = BitmapDataAsset(this.var_106).var_1256;
            this.var_1257 = BitmapDataAsset(this.var_106).var_1257;
            if(this._bitmap != null)
            {
               this.var_106 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               ...
               case "flipH":
                  ...
                  break;
               case "flipV":
                  this.var_1257 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
