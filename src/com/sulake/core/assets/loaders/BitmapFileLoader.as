package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_996 = new LoaderContext();
         this.var_996.checkPolicyFile = true;
         ...
         {
            this.var_41.load(param2,this.var_996);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_314 = 0;
         this.var_41.load(param1,this.var_996);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_314 < var_2739)
            {
               ...
               this.var_41.load(new URLRequest(this.var_997 + (this.var_997.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_314),this.var_996);
               return true;
            }
         }
         return false;
