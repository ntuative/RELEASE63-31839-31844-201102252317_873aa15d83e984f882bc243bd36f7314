package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1169:String = "AssetLibraryReady";
      
      public static const const_728:String = "AssetLibraryLoaded";
      
      public static const const_1420:String = "AssetLibraryUnloaded";
      
      public static const const_1449:String = "AssetLibraryLoadError";
      
      private static var var_290:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_482:uint = 0;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_715 = new XML();
         this.var_401 = 0;
         this.var_403 = new Array();
         if(var_290 == null)
         {
            var_290 = new Dictionary(false);
         ...
         ++var_482;
         this.var_402 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_876.splice(var_876.indexOf(this),1);
            --var_482;
            this.var_481 = null;
            this.var_875 = null;
            this.var_144 = null;
      ...
      {
         if(this._file == param1.url && this.var_874)
         {
            if(!this.var_877 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_715,this.var_570);
            }
            this.var_877 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1169));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_481)
         {
            _loc2_ = this.var_481[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_481[_loc1_];
         }
      ...
      {
         var _loc2_:Class = this.var_875[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_481[param2.url];
         if(_loc4_ != null)
         {
         ...
         var _loc6_:IAssetLoader = new _loc5_.method_15(_loc5_.mimeType,param2);
         if(_loc6_ == null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1019,this.assetLoadEventHandler);
         ...
         this.var_481[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_481[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_401;
                     this.var_403.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_481[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_403.length ? this.getAssetByName(this.var_403[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_144)
         {
            ...
            {
               return this.var_403.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_144[param1] != null || (this.var_570 != null ? this.var_570[param1] != null : false);
      }
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_144)
            {
               if(this.var_144[_loc2_] == param1)
               {
                  this.var_403.splice(this.var_403.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_290.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_290[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_402.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_402[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_290[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_402[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_290)
            {
               _loc3_ = AssetTypeDeclaration(var_290[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_402)
         {
            _loc3_ = AssetTypeDeclaration(this.var_402[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_290)
            {
               _loc4_ = AssetTypeDeclaration(var_290[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_402)
         {
            _loc4_ = AssetTypeDeclaration(this.var_402[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_715 = _loc2_.manifest.copy();
         this.var_570 = _loc2_.resource;
         ...
         this.var_874 = true;
         dispatchEvent(new Event(AssetLibrary.const_728));
         dispatchEvent(new Event(AssetLibrary.const_1169));
         if(this.var_877)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1449));
         this.var_41 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_715.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_570[param1]);
