package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerViewer extends TextField implements IDisposable
   {
      ...
      public function ProfilerViewer(param1:IProfiler)
      {
         ...
         {
            this.var_253 = param1;
            this.var_253.addStopEventListener(this.refresh);
         }
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_253)
            {
               this.var_253.removeStopEventListener(this.refresh);
               this.var_253 = null;
            }
            this._disposed = true;
         }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = this.var_253.getProfilerAgentsInArray();
