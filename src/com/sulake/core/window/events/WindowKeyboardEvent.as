package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      {
         _type = param1;
         this.var_683 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get charCode() : uint
      {
         return this.var_683.charCode;
      }
      
      public function get keyCode() : uint
      {
         return this.var_683.keyCode;
      }
      
      public function get keyLocation() : uint
      {
         return this.var_683.keyLocation;
      }
      
      public function get altKey() : Boolean
      {
         return this.var_683.altKey;
      }
      
      public function get shiftKey() : Boolean
      {
         return this.var_683.shiftKey;
      }
      
      override public function clone() : Event
      {
         return new WindowKeyboardEvent(_type,this.var_683,window,related,bubbles,cancelable);
      }
