package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1103:uint = 0;
      ...
      protected static const const_1668:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1385:Point = new Point();
      ...
      protected var var_648:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_774 = _loc13_.blend;
            var_446 = _loc13_.var_2732;
            if(var_445 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_229 != _loc13_.color)
            {
      ...
      {
         return this.var_648 != null ? this.var_648 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_445 = param1;
         var_229 = !!var_445 ? uint(var_229 | var_529) : uint(var_229 & 16777215);
      ...
      {
         var_799 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_548,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_529 = param1 & 4278190080;
         var_229 = !!var_445 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_65);
      }
      ...
      {
         var_529 = param1 << 24;
         var_229 = !!var_445 ? uint(var_529 | var_229) : uint(16777215 & var_229);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_65);
      }
      
      public function set blend(param1:Number) : void
      {
         var_774 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1000);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_458,this,null));
         }
      }
      ...
      {
         var_446 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_498,this,this._parent));
            }
            else
            {
               this.var_344.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1090,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_848,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_82,var_18,_context,var_11,null,this.var_648,this.properties,var_798.concat(),_id) as WindowController;
         _loc2_.var_446 = var_446;
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_102))
                  {
                     this.deactivate();
                  }
               }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2441 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_487)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1161,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_703,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_566,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_188,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_663))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1053;
                  if(testParamFlag(WindowParam.const_402))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_220))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_188:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_515,this,null));
                     if(testParamFlag(WindowParam.const_179,WindowParam.const_157))
                     {
                     ...
                     if(this._parent != null)
                     {
                        ...
                        var_18 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_291,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_566:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.const_571);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1213,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_294,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_370:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_637,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_238,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_458:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_989);
                  break;
               case WindowNotifyEvent.const_483:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1668) == -1)
                     {
                        _loc8_.style = var_82;
                     }
                  }
               ...
               case WindowNotifyEvent.const_548:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_571);
                     }
                  }
                  else if(var_18 & 0)
                  {
                  ...
                  break;
               case WindowNotifyEvent.const_498:
                  if(testParamFlag(WindowParam.const_179,WindowParam.const_157))
                  {
                     this.updateScaleRelativeToParent();
                  }
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1078:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1418:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1471:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1028:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1203:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_446);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_446);
      }
         ...
         if(this.var_165 && var_446 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1385,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1385,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_138,WindowParam.const_157);
         var _loc2_:* = !testParamFlag(WindowParam.const_126,WindowParam.const_160);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_365)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_299)
               {
      ...
      {
         if(_state == WindowState.const_529)
         {
            return true;
         }
         _state = WindowState.const_529;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1152,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function maximize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_63,true);
         _loc1_.type = WindowNotifyEvent.const_1028;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_102,true);
      ...
      public function deactivate() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_102,false);
         _loc1_.type = WindowNotifyEvent.const_1078;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1020,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_620;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1102 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_350,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1102 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_612,this,param1));
         return param1;
      }
