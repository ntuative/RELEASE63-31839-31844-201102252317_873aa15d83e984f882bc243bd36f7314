package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1254:String = "_TITLE";
      
      private static const const_1279:String = "_HEADER";
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1254) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1367 = findChildByTag(const_1279) as IHeaderWindow;
            if(!this.var_1367)
            {
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_281);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_320,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            ...
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,_loc3_.top,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_264,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         }
         else
         {
