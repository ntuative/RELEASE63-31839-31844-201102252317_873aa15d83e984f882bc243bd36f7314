package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_655:Boolean = false;
      ...
      {
         this.var_1239 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_20)
         {
            var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_973,var_11);
         }
         return var_20;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_441)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_655 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_336,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_798,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1440);
         _loc1_.push(this.var_1238 != PropertyDefaults.const_1058 ? new PropertyStruct(PropertyDefaults.const_705,this.var_1238,PropertyStruct.const_35,true) : PropertyDefaults.const_1500);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1159 ? new PropertyStruct(PropertyDefaults.const_616,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1481);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1145 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1598);
         return _loc1_;
      }
