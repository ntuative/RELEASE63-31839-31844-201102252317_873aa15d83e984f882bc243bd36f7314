package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_324:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_324);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2165 = _loc2_.textWidth;
         this.var_2164 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_324 != _loc2_.color : this.var_324 != null && this.var_324 != PropertyDefaults.const_753) ? new PropertyStruct(PropertyDefaults.const_401,this.var_324,PropertyStruct.const_150,true) : PropertyDefaults.const_1177);
         if(this.var_38)
         {
            if(this.var_38.left != PropertyDefaults.const_665)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_226,this.var_38.left,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_545);
            }
            if(this.var_38.top != PropertyDefaults.const_653)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,this.var_38.top,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_509);
            }
            if(this.var_38.right != PropertyDefaults.const_611)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,this.var_38.right,PropertyStruct.const_39,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_580);
            }
            if(this.var_38.bottom != PropertyDefaults.const_859)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_264,this.var_38.bottom,PropertyStruct.const_39,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_401:
                  this.var_324 = _loc2_.value as uint;
                  break;
