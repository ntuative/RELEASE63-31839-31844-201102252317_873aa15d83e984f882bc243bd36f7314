package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_186);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_724 ? true : null;
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1068) ? new PropertyStruct(PropertyDefaults.const_873,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1205) : PropertyDefaults.const_1577);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1109 ? new PropertyStruct(PropertyDefaults.const_820,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_982) : PropertyDefaults.const_1636);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1064 ? new PropertyStruct(PropertyDefaults.const_1031,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1029) : PropertyDefaults.const_1604);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_753) ? new PropertyStruct(PropertyDefaults.const_401,this._field.textColor,PropertyStruct.const_150,true) : PropertyDefaults.const_1177);
         _loc1_.push(this.var_418 != TextStyleManager.const_186 ? new PropertyStruct(PropertyDefaults.const_408,this.var_418,PropertyStruct.const_52,true,PropertyDefaults.const_805) : PropertyDefaults.const_1002);
         _loc1_.push(this.var_38.left != PropertyDefaults.const_665 ? new PropertyStruct(PropertyDefaults.const_226,this.var_38.left,PropertyStruct.const_39,true) : PropertyDefaults.const_545);
         _loc1_.push(this.var_38.top != PropertyDefaults.const_653 ? new PropertyStruct(PropertyDefaults.const_242,this.var_38.top,PropertyStruct.const_39,true) : PropertyDefaults.const_509);
         _loc1_.push(this.var_38.right != PropertyDefaults.const_611 ? new PropertyStruct(PropertyDefaults.const_228,this.var_38.right,PropertyStruct.const_39,true) : PropertyDefaults.const_580);
         _loc1_.push(this.var_38.bottom != PropertyDefaults.const_859 ? new PropertyStruct(PropertyDefaults.const_264,this.var_38.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_460);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1191 ? new PropertyStruct(PropertyDefaults.const_628,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1489);
