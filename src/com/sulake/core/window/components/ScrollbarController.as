package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1321:String = "increment";
      
      private static const const_1320:String = "decrement";
      
      private static const const_951:String = "slider_track";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_19.removeEventListener(WindowEvent.const_48,this.onScrollableResized);
            this.var_19.removeEventListener(WindowEvent.const_502,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_48,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_502,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_951) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_498)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_323)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_441)
         {
            ...
            else if(param2.name == const_1320)
            {
               if(this.var_19)
               {
                  this.var_1160 = true;
         ...
         if(param1.type == WindowMouseEvent.const_323)
         {
