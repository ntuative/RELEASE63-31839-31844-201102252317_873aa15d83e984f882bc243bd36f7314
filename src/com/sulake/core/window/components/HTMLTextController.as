package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_896:String = "default";
      
      private var var_1097:String = null;
      
      private var var_1699:StyleSheet = null;
      ...
      {
         if(PropertyDefaults.const_651.indexOf(param1) > -1)
         {
            this.var_896 = param1;
         }
      }
      ...
      {
         return this.var_896 == LinkTarget.const_31 ? defaultLinkTarget : this.var_896;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_1699;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_896 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_693,this.var_896,PropertyStruct.const_52,true,PropertyDefaults.const_651));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1400);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_896 = _loc2_.value as String;
               break;
            }
