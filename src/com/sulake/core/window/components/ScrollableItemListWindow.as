package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_391)
         {
            this.var_391.removeEventListener(WindowEvent.const_278,this.scrollBarEventProc);
            this.var_391.removeEventListener(WindowEvent.const_235,this.scrollBarEventProc);
            this.var_391 = null;
         }
         if(this.var_1052)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_391)
         {
            this.var_391 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_391)
            {
               this.var_391.addEventListener(WindowEvent.const_278,this.scrollBarEventProc);
               this.var_391.addEventListener(WindowEvent.const_235,this.scrollBarEventProc);
            }
         }
         return this.var_391;
      }
