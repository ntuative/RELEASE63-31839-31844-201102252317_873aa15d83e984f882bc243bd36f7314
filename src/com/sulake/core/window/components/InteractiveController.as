package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_442[0] = MouseCursorType.const_347;
         this.var_442[1] = MouseCursorType.const_31;
         this.var_442[2] = MouseCursorType.const_347;
         this.var_442[3] = MouseCursorType.const_347;
         this.var_442[4] = MouseCursorType.const_31;
         this.var_442[5] = MouseCursorType.const_31;
         this.var_442[6] = MouseCursorType.const_347;
         if(var_273 == null)
         {
            var_273 = new Array();
            var_273[0] = WindowState.const_102;
            var_273[1] = WindowState.const_82;
            var_273[2] = WindowState.const_86;
            var_273[3] = WindowState.const_63;
            var_273[4] = WindowState.const_53;
            var_273[5] = WindowState.const_93;
            var_273[6] = WindowState.const_76;
         }
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_551)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_175)
            {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_710:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_551)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_710,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1625);
         }
         if(param1.toolTipDelay != PropertyDefaults.TOOL_TIP_DELAY_VALUE)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_813,param1.toolTipDelay,PropertyStruct.const_249,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1392);
         }
         return param2;
      }
