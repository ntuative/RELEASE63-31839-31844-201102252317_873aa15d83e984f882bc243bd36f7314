package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_191:ISelectableWindow;
      
      protected var var_1979:Boolean = true;
      ...
      {
         return this.var_191 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_191)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_360,this,this.var_191));
               }
            }
         }
      }
