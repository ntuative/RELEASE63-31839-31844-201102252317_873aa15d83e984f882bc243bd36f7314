package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1996:Boolean = false;
      ...
      protected var var_999:Boolean = true;
      
      protected var var_448:Boolean = false;
      
      protected var var_1235:Boolean = false;
      
      protected var var_1995:int = 0;
      
      protected var var_1997:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_103 = 0;
         this.var_92 = 0;
         this._horizontal = param2 == WindowType.const_364;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_165 = var_445 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_379,WindowStyle.const_901,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_304,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_651 * this.maxScrollH,this.var_652 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_651 = param1;
            this._container.x = -this.var_651 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_65);
            dispatchEvent(new WindowEvent(WindowEvent.const_502,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_652 = param1;
            this._container.y = -this.var_652 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_65);
            dispatchEvent(new WindowEvent(WindowEvent.const_502,this,null));
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_304,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_175:
               if(this.var_1236)
               {
                  this.var_1237 = this.var_1995 - _loc3_;
                  this.var_1234 = this.var_1997 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1237 != 0 && this.var_103 != 0)
                     {
                        this.scrollH += this.var_1237 / this.var_103;
                     }
                  }
                  else if(this.var_1234 != 0 && this.var_92 != 0)
                  {
                     this.scrollV += this.var_1234 / this.var_92;
                  }
                  this.var_1995 = _loc3_;
                  this.var_1997 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_189:
               if(this.var_1236)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1237,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1234);
                  }
                  this.var_1236 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_999 && !this.var_533 && this._container)
         {
            this.var_533 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_406,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1024);
         }
         if(this.var_999 != PropertyDefaults.const_1117)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_826,this.var_999,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1457);
         }
         if(this.var_448 != PropertyDefaults.const_1069)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_658,this.var_448,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1570);
         }
         if(this.var_1235 != PropertyDefaults.const_1144)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_864,this.var_1235,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1476);
         }
         return _loc1_;
      }
