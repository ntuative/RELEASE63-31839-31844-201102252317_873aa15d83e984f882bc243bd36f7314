package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_949:uint = 8;
      
      private static const const_1317:String = "skin";
      
      private static const const_1314:String = "bitmap";
      
      private static const const_1315:String = "fill";
      
      private static const const_1318:String = "text";
      
      private static const const_1319:String = "label";
      
      private static const const_1316:String = "shape";
      ...
      private var var_939:Dictionary;
      
      private var var_420:Dictionary;
      
      private var var_1812:Dictionary;
      
      private var var_2584:Dictionary;
      
      private var var_2583:Dictionary;
      
      private var var_2582:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1812 = new Dictionary();
         this.var_2584 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1812,this.var_2584);
         this.var_2583 = new Dictionary();
         this.var_2582 = new Dictionary();
         StateCodeTable.fillTables(this.var_2583,this.var_2582);
         this.var_420 = new Dictionary();
         this.var_420[const_1317] = BitmapSkinRenderer;
         this.var_420[const_1314] = BitmapDataRenderer;
         this.var_420[const_1315] = FillSkinRenderer;
         this.var_420[const_1318] = TextSkinRenderer;
         this.var_420[const_1319] = LabelRenderer;
         this.var_420[const_1316] = ShapeSkinRenderer;
         this.var_420[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_420[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_317 == null)
         {
            var_317 = new Array();
            var_317.push(WindowState.const_63);
            var_317.push(WindowState.const_76);
            var_317.push(WindowState.const_93);
            var_317.push(WindowState.const_53);
            var_317.push(WindowState.const_86);
            var_317.push(WindowState.const_82);
            var_317.push(WindowState.const_102);
            var_317.push(WindowState.const_97);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2732 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1812[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_938[param1] == null)
         {
            this.var_938[param1] = new Array(const_949);
         }
         this.var_938[param1][param2] = param3;
         if(this.var_939[param1] == null)
         {
            this.var_939[param1] = new Array(const_949);
         }
         this.var_939[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_938[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_939[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_199)
