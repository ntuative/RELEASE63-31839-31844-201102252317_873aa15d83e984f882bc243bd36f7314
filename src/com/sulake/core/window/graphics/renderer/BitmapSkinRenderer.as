package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_801:Dictionary;
      
      protected var var_802:Dictionary;
      
      private var var_920:Matrix;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_801 = new Dictionary(false);
         this.var_802 = new Dictionary(false);
         this.var_920 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_920 = null;
            for(_loc1_ in this.var_801)
            {
               _loc2_ = this.var_801[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_801[_loc1_];
            }
            this.var_801 = null;
            for(_loc1_ in this.var_802)
            {
               _loc2_ = this.var_802[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_802[_loc1_];
            }
            this.var_802 = null;
         }
      }
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_453)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_453)
                  {
                     _loc13_ = true;
                  ...
                  {
                     this.var_920.a = 0 / _loc17_.width;
                     this.var_920.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_34.width,var_34.height,false);
                     _loc30_.draw(_loc17_,this.var_920);
                     _loc31_ = new BitmapData(var_34.width,var_34.height,true,0);
                     _loc31_.draw(_loc18_,this.var_920,null);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_801[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_802[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
