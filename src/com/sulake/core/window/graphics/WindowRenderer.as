package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_350:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1761 = new Point();
         this.var_1406 = new Rectangle();
         this.var_298 = new Rectangle();
         this.var_350 = new Dictionary(true);
         this.var_811 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_743 = null;
            for(_loc1_ in this.var_350)
            {
               delete this.var_350[_loc1_];
            }
            this.var_350 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.getWindowRendererItem(param1).invalidate(param1,this.var_298,WindowRedrawFlag.const_1195);
            if(this.var_743.indexOf(param1) == -1)
            {
      ...
      {
         var _loc2_:WindowRendererItem = this.var_350[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_350[param1];
         }
         return _loc2_;
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_743.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_743.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1761,this.var_1406))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1761,this.var_1406))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_32))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1406);
