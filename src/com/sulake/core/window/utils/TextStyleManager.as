package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_186:String = "regular";
      ...
      private static var var_489:Array;
      ...
      private static const const_1284:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_85[const_186],var_85[ITALIC],var_85[BOLD]];
            var_85.reset();
            var_85[const_186] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_489.indexOf(_loc4_.name) == -1)
            {
               var_489.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1283) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1284) + 2,_loc5_.length);
            }
