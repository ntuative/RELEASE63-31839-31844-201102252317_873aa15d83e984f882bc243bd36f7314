package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1027:String = "_EXCLUDE";
      
      public static const const_1902:String = "_INCLUDE";
      
      public static const const_1946:String = "_TEMP";
      
      private static const const_1248:String = "layout";
      
      private static const const_912:String = "window";
      
      private static const const_914:String = "variables";
      
      private static const const_913:String = "filters";
      
      private static const const_590:String = "name";
      
      private static const const_1238:String = "style";
      
      private static const const_588:String = "params";
      
      private static const const_1241:String = "tags";
      ...
      private static const const_1239:String = "visible";
      
      private static const const_1237:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1000:String = "blend";
      
      private static const const_1244:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1247:String = "treshold";
      
      private static const const_1243:String = "children";
      
      private static const const_1249:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1242:String = "height_min";
      
      private static const const_1240:String = "height_max";
      
      private static const const_589:String = "true";
      
      private static const const_156:String = "0";
      ...
      private static const const_1236:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1223:Dictionary;
      
      protected var var_1224:Dictionary;
      
      protected var var_990:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1224 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1223,this.var_1224);
         this.var_990 = new Dictionary();
         this.var_1485 = new Dictionary();
         ParamCodeTable.fillTables(this.var_990,this.var_1485);
         this.var_1977 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1236,const_47);
         return param1.replace(const_1245,const_47);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1223)
            {
               delete this.var_1223[_loc1_];
            }
            for(_loc1_ in this.var_1224)
            {
               delete this.var_1224[_loc1_];
            }
            for(_loc1_ in this.var_990)
            {
               delete this.var_990[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1248)
         {
            _loc8_ = param1.child(const_914);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_913).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1223[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_590,variables,"")));
         style = uint(this.parseAttribute(xml,const_1238,variables,style));
         params = uint(this.parseAttribute(xml,const_588,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1241,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_156));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_156));
         rect.width = Number(this.parseAttribute(xml,const_1228,variables,const_156));
         rect.height = Number(this.parseAttribute(xml,const_1227,variables,const_156));
         visible = this.parseAttribute(xml,const_1239,variables,visible.toString()) == const_589;
         ...
         if(xml.child(const_588).length() > 0)
         {
            ...
            while(i < length)
            {
               ...
               if(this.var_990[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_590)) + "\"!");
               }
               params |= this.var_990[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_47) : const_47;
         caption = unescape(String(this.parseAttribute(xml,const_1237,variables,caption)));
         if(tag != const_47)
         {
            tags = tag.split(const_1229);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_914)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1249,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1242,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1240,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_589;
         blend = Number(this.parseAttribute(xml,const_1000,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1244,variables,window.clipping.toString()) == const_589;
         ...
         list = xml.child(const_913).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1224[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1027) == -1)
                  {
