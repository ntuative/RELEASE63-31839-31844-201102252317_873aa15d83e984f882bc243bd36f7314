package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_83:WindowController;
      
      protected var var_154:IWindowRenderer;
      
      protected var var_139:IDesktopWindow;
      
      protected var var_806:IWindowContextStateListener;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_189;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_83 = param1.var_1222 as WindowController;
         this._lastClickTarget = param1.var_1219 as WindowController;
         this.var_154 = param1.renderer;
         this.var_806 = param1.var_1220;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_653.x || _loc3_.stageY != this.var_653.y)
            {
               this.var_653.x = _loc3_.stageX;
               this.var_653.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_139.groupParameterFilteredChildrenUnderPoint(this.var_653,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_83 != this.var_139 && !this.var_83.disposed)
                  {
                     this.var_83.getGlobalPosition(_loc7_);
                     this.var_83.update(this.var_83,new WindowMouseEvent(WindowMouseEvent.const_25,this.var_83,null,_loc3_.stageX - _loc7_.x,_loc3_.stageY - _loc7_.y,_loc3_.stageX,_loc3_.stageY,_loc3_.altKey,_loc3_.ctrlKey,_loc3_.shiftKey,_loc3_.buttonDown,_loc3_.delta));
                     this.var_83 = WindowController(this.var_139);
                  }
               }
            }
            while(--_loc4_ > -1)
            {
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  if(_loc3_.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(_loc5_ != this.var_83)
                     {
                        if(!this.var_83.disposed)
                        {
                           this.var_83.getGlobalPosition(_loc7_);
                           this.var_83.update(this.var_83,new WindowMouseEvent(WindowMouseEvent.const_25,this.var_83,_loc5_,_loc3_.stageX - _loc7_.x,_loc3_.stageY - _loc7_.y,_loc3_.stageX,_loc3_.stageY,_loc3_.altKey,_loc3_.ctrlKey,_loc3_.shiftKey,_loc3_.buttonDown,_loc3_.delta));
                        }
                        if(!_loc5_.disposed)
                        {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_83 && !this.var_83.disposed)
                     {
                        ...
                        {
                           this.var_806.mouseEventReceived(_loc3_.type,this.var_83);
                        }
                     }
                  }
                  ...
                  if(_loc3_.altKey)
                  {
                     if(this.var_83)
                     {
                        Logger.log("HOVER: " + this.var_83.name);
                     }
                  }
         ...
         param1.var_1222 = this.var_83;
         param1.var_1219 = this._lastClickTarget;
         param1.renderer = this.var_154;
         param1.var_1220 = this.var_806;
      }
