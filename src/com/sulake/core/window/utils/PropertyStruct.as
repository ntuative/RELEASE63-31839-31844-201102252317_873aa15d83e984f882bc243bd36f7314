package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2782 = param3 == const_248 || param3 == const_124 || param3 == const_221 || param3 == const_219;
      ...
      public function toString() : String
      {
         ...
         {
            case const_150:
               return "0x" + uint(this.var_175).toString(16);
            case const_35:
               return Boolean(this.var_175) == true ? "true" : "IInventoryView";
            case const_221:
               return "Point(" + Point(this.var_175).x + ", " + Point(this.var_175).y + ")";
            case const_219:
               return "Rectangle(" + Rectangle(this.var_175).x + ", " + Rectangle(this.var_175).y + ", " + Rectangle(this.var_175).width + ", " + Rectangle(this.var_175).height + ")";
            default:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_221:
               ...
               break;
            case const_219:
               _loc6_ = this.var_175 as Rectangle;
               _loc1_ = "<var key=\"" + this.var_591 + "\">\r<value>\r<" + this._type + ">\r";
               ...
               break;
            case const_150:
               _loc1_ = "<var key=\"" + this.var_591 + "\" value=\"" + "0x" + uint(this.var_175).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_591 + "\" value=\"" + this.var_175 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
