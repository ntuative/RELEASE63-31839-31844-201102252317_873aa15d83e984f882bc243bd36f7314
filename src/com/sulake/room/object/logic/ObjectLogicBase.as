package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_346:IRoomObjectController;
      ...
      public function set object(param1:IRoomObjectController) : void
      {
         ...
         {
            this.var_346.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_346 = param1;
            this.var_346.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_346 != null)
            {
               this.var_346.setLocation(param1.loc);
               this.var_346.setDirection(param1.dir);
            }
         }
      }
   }
