package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1494:int = 0;
      ...
      private var var_2810:IRoomContentLoader;
      
      private var var_554:IRoomObjectFactory = null;
      
      private var var_469:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1055:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_555 = [];
         this.var_556 = [];
         events.addEventListener(RoomContentLoadedEvent.const_404,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_463,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_554 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_554 == null || this.var_469 == null)
         {
            return;
         }
         this._state = const_1612;
         if(this.var_1055 != null)
         {
            _loc1_ = this.var_1055;
            this.var_1055 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_555.indexOf(_loc5_) < 0)
            {
               this.var_50.loadObjectContent(_loc5_,events);
               this.var_555.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1040;
         return true;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_556.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_556.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_556.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_556[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_554.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_554 != null)
         {
            return this.var_554.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_50 == null || this.var_469 == null)
         {
            return;
         }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_554.createRoomObjectLogic(_loc18_);
