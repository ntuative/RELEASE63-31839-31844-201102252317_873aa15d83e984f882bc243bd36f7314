package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_154:IRoomRendererBase;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_245 != null)
         {
            ...
            {
               _loc3_ = this.var_245.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_556.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_556[_loc2_]);
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_154 != null)
            {
               this.var_154.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_154)
               {
                  this.var_154.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_154)
                  {
                     this.var_154.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_154.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      {
         return this.var_245.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_245.getValue(_loc2_) != null)
         {
            return this.var_245.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_245.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_245.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_245.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_245.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
