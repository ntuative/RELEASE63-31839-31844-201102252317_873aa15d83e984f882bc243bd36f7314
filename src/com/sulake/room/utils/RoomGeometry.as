package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_817:Number = 64;
      
      public static const const_1097:Number = 32;
      ...
      private var var_2796:Number = -500.0;
      
      private var var_2795:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1872 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_153.x,this.var_153.y,this.var_153.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_81.x * this.var_435,this.var_81.y * this.var_433,this.var_81.z * this.var_434);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_263.x,this.var_263.y,this.var_263.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_435 != param1 * this.var_1874)
         {
            this.var_435 = param1 * this.var_1874;
            ++this.var_162;
         }
      }
      ...
      {
         if(this.var_433 != param1 * this.var_1873)
         {
            this.var_433 = param1 * this.var_1873;
            ++this.var_162;
         }
      }
      ...
      {
         if(this.var_434 != param1 * this.var_1872)
         {
            this.var_434 = param1 * this.var_1872;
            ++this.var_162;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_81.x /= this.var_435;
         this.var_81.y /= this.var_433;
         this.var_81.z /= this.var_434;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_263.x;
         var _loc3_:Number = this.var_263.y;
         var _loc4_:Number = this.var_263.z;
         this.var_263.assign(param1);
         if(this.var_263.x != _loc2_ || this.var_263.y != _loc3_ || this.var_263.z != _loc4_)
         {
            ++this.var_162;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_153.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_152.assign(_loc19_);
            this.var_153.assign(_loc20_);
         }
      }
      ...
      {
         if(param1 == null || this.var_153 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_153,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_153);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_433;
         _loc2_.z *= this.var_434;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1189);
         if(_loc3_ < this.var_2796 || _loc3_ > this.var_2795)
         {
            return null;
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_152,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_81.x * this.var_435,this.var_81.y * this.var_433,this.var_81.z * this.var_434);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_153;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_435,param2.y * this.var_433,param2.z * this.var_434);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_435,param3.y * this.var_433,param3.z * this.var_434);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_435,param4.y * this.var_433,param4.z * this.var_434);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1097;
         }
         else
         {
            this.scale = const_817;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_817;
      }
