package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1700:int = 50;
      ...
      private var var_249:BitmapDataCache;
      
      private var var_603:RoomObjectCache;
      
      private var var_508:Array;
      
      private var var_600:Array;
      
      private var var_1419:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2550:Number = -1.0E7;
      
      private var var_2552:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_250.addChild(this.var_58);
         ...
         this.var_249 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_603 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_507.x -= param1 - this.var_601;
         this.var_601 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_507.y -= param1 - this.var_602;
         this.var_602 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_956 = true;
            if(this.var_131 != null && !this.var_250.contains(this.var_131))
            {
               this.var_250.addChild(this.var_131);
               this.var_58.mask = this.var_131;
            }
         }
         else if(!param1 && this.var_956)
         {
            this.var_956 = false;
            if(this.var_131 != null && this.var_250.contains(this.var_131))
            {
               this.var_250.removeChild(this.var_131);
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_131 != null)
         {
            this.var_131.graphics.clear();
         }
         else
         {
            this.var_131 = new Sprite();
            this.var_131.name = "mask";
            if(this.var_956)
            {
               this.var_250.addChild(this.var_131);
               this.var_58.mask = this.var_131;
         ...
         this.var_131.graphics.beginFill(0);
         this.var_131.graphics.drawRect(0,0,param1,param2);
         this.var_750 = param1;
         this._ht = param2;
      }
      ...
      {
         this.var_603.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(param1 == this.var_2554)
         {
            return;
         }
         this.var_249.compress();
         ...
         if(this.var_750 != this.var_2551 || this._ht != this.var_2553)
         {
            _loc9_ = true;
         }
         if(this.var_58.x != this.var_601 || this.var_58.y != this.var_602)
         {
            this.var_58.x = this.var_601;
            this.var_58.y = this.var_602;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_508.sortOn("z",0 | 0);
         if(_loc5_ < this.var_508.length)
         {
            this.var_508.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_508[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2551 = this.var_750;
         this.var_2553 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_603.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_603.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc19_ < this.var_750 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_751 || this.var_751 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_508.length)
         {
            return null;
         }
         return this.var_508[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_249.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_249.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_249.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_249.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_601;
         param2 -= this.var_602;
         this.var_507.x = param1;
         this.var_507.y = param2;
         if(this.var_1143 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
      ...
      {
         var _loc11_:Number = param1 - this.var_750 / 2;
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_599.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_599.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2550 || param2 != this.var_2552)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_599.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_599.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_353 != null && param1 != null)
         {
            this.var_353.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_353 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_353.getKey(_loc1_);
            _loc3_ = this.var_353.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1419.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1143 == 0)
         {
            this.checkMouseHits(this.var_507.x,this.var_507.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1143 = 0;
         ++this.var_1795;
      }
