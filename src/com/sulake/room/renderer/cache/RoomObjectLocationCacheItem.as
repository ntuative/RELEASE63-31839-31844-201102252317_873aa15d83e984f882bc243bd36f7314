package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1856 || param1.getUpdateID() != this.var_2640)
         {
            this.var_2640 = param1.getUpdateID();
            if(param2.updateId != this.var_1856 || _loc4_.x != this.var_1181.x || _loc4_.y != this.var_1181.y || _loc4_.z != this.var_1181.z)
            {
               this.var_1856 = param2.updateId;
               this.var_1181.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2641 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     this.var_366 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
